...
public final class IntRange extends Range implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>IntRange</code> using the specified number as both the minimum
  ...
  /**
   * <p>
   * Constructs a new <code>IntRange</code> with the specified minimum and maximum numbers
   * (both inclusive).
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Tests whether the specified range overlaps with this range using <code>int</code>
   * comparison.
   * </p>
   * 
   * <p>
  ...
  public boolean overlapsRange(Range range) {
    ...
    return range.containsInteger(min) || range.containsInteger(max) || containsInteger(range
        .getMinimumInteger());
  }
