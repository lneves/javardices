 ...
 * 
 * <p>
 * This class is intended to be used as a singleton. There is no need to instantiate a new
 * style each time. Simply instantiate the class once, customize the values as required,
 * and store the result in a public static final variable for the rest of the program to
 * access.
 * </p>
 * 
 ...
 * @author Gary Gregory
 * @since 1.0
 * @version $Id: StandardToStringStyle.java 437554 2006-08-28 06:21:41Z bayard $
 */
public class StandardToStringStyle extends ToStringStyle {
  ...
  /**
   * Gets the end text to output when a <code>Collection</code>, <code>Map</code> or
   * <code>Array</code> size is output.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Sets the end text to output when a <code>Collection</code>, <code>Map</code> or
   * <code>Array</code> size is output.
   * </p>
   * 
   * <p>
