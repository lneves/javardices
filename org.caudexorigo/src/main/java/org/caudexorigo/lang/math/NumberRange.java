...
/**
 * <p>
 * <code>NumberRange</code> represents an inclusive range of {@link java.lang.Number}
...
public final class NumberRange extends Range implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>NumberRange</code> using the specified number as both the
   * minimum and maximum in this range.
   * </p>
   * 
   * @param num the number to use for this range
   * @throws IllegalArgumentException if the number is <code>null</code>
   * @throws IllegalArgumentException if the number doesn't implement
   *         <code>Comparable</code>
   * @throws IllegalArgumentException if the number is <code>Double.NaN</code> or
   *         <code>Float.NaN</code>
   */
  ...
  /**
   * <p>
   * Constructs a new <code>NumberRange</code> with the specified minimum and maximum
   ...
   * 
   * <p>
   * This constructor is designed to be used with two <code>Number</code> objects of the
   * same type. If two objects of different types are passed in, an exception is thrown.
   * </p>
   * 
   ...
   * @throws IllegalArgumentException if the numbers don't implement
   *         <code>Comparable</code>
   */
