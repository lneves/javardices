...
/**
 * The <code>ResourceBundleMessageProvider</code> deals with messages defined in resource bundles. Messages defined in resource bundles can be grouped together by adding the entry key at the end of the message key separated by a dot.
 */
public class ResourceBundleMessageProvider implements MessageProvider
{
	 ...
	 *             Thrown if the resource bundle does not exist.
	 */
	public ResourceBundleMessageProvider(String baseName) throws MessageNotFoundException
	{
		...
		{
			String msg = MessageFormat.format(I18nUtils.INTERNAL_MESSAGES.getString(I18nUtils.RESOURCE_BUNDLE_NOT_FOUND), new Object[] { baseName });
	...
	public String getText(String id, String entry, Locale locale) throws MessageNotFoundException
	{
		...
		{
			logger.log(Level.WARNING, MessageFormat.format(I18nUtils.INTERNAL_MESSAGES.getString(I18nUtils.NO_MESSAGE_ENTRIES_FOUND), new Object[] { id }));
			return null;
		}
	}
	...
	public Map<String, String> getEntries(String id, Locale locale)
	{
		...
		if (entries == null)
		{
			throw new MessageNotFoundException(MessageFormat.format(I18nUtils.INTERNAL_MESSAGES.getString(I18nUtils.NO_MESSAGE_ENTRIES_FOUND), new Object[] { id }));
		}
		return entries;
	}
}