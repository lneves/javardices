...
public class Win1252Cleaner {
  ...
  // except for codes 129, 141, 143, 144 and 157 ( Control Chars)
  // where the 'Replacement character' was used (0xfffd)
  private static char[] REPLACEMENT_CHARS = {0x20ac, 0xfffd, 0x201a, 0x0192, 0x201e, 0x2026, 0x2020,
      0x2021, 0x02c6, 0x2030, 0x0160, 0x2039, 0x0152, 0xfffd, 0x017d, 0xfffd, 0xfffd, 0x2018,
      0x2019, 0x201c, 0x201d, 0x2022, 0x2013, 0x2014, 0x02dc, 0x2122, 0x0161, 0x203a, 0x0153,
      0xfffd, 0x017e, 0x0178};
  ...
  private static void testClean() {
    ...
    String bogus_text =
        "Núcleo da Liga Portuguesa Contra o Cancro abre em Abrantes. OJL Redux toca hoje nOs Artistas";
