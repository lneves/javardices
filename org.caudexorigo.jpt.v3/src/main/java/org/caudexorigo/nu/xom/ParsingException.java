...
/**
 * <p>
 * The generic superclass for all the checked exceptions thrown in XOM. The general
 * principle followed is that anything that could plausibly be detected by testing such as
 * using spaces in an element name is a runtime exception. Exceptions that depend on
 * environmental conditions, such as might occur when parsing an external file, are
 * checked exceptions, because these depend on variable input, and thus problems may not
 * all be detected during testing.
 * </p>
 * 
...
public class ParsingException extends Exception {
  ...
  /**
   * <p>
   * Creates a new <code>ParsingException</code> with a detail message and an underlying
   * root cause.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a new <code>ParsingException</code> with a detail message and line and column
   * numbers.
   * </p>
   * 
   * @param message a string indicating the specific problem
  ...
  /**
   * <p>
   * Creates a new <code>ParsingException</code> with a detail message, line and column
  ...
  /**
   * <p>
   * Returns the approximate row number of the construct that caused this exception. If
   * the row number is not known, -1 is returned.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the approximate column number of the construct that caused this exception. If
   * the column number is not known, -1 is returned.
   * </p>
   * 
   ...
   * If this is not known, for instance because the document was parsed from a raw input
   * stream or from a string, it returns null.
   * </p>
   * 
  ...
  /**
   * <p>
   * Sets the root cause of this exception. This may only be called once. Subsequent calls
   * throw an <code>IllegalStateException</code>.
   * </p>
   * 
   * <p>
   * This method is unnecessary in Java 1.4 where it could easily be inherited from the
   * superclass. However, including it here allows this method to be used in Java 1.3 and
   * earlier.
   * </p>
   *
   ...
   * 
   * @throws IllegalArgumentException if the cause is this exception (An exception cannot
   *         be its own cause.)
  ...
  /**
   * <p>
   * Returns a string suitable for display to the developer summarizing what went wrong
   * where.
   * </p>
   * 
