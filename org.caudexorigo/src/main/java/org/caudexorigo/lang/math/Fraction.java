...
/**
 * <p>
 * <code>Fraction</code> is a <code>Number</code> implementation that stores fractions
 * accurately.
 * </p>
 * 
 * <p>
...
public final class Fraction extends Number implements Comparable {
  ...
  /**
   * <p>
   * Creates a reduced <code>Fraction</code> instance with the 2 parts of a fraction Y/Z.
   * </p>
   * 
   * <p>
   * For example, if the input parameters represent 2/4, then the created fraction will be
   * 1/2.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * This method uses the <a href="http://archives.math.utk.edu/articles/atuyl/confrac/">
   * continued fraction algorithm</a>, computing a maximum of 25 convergents and bounding
   * the denominator by 10,000.
   * </p>
   * 
   * @param value the double value to convert
   * @return a new fraction instance that is close to the value
   * @throws ArithmeticException if <code>|value| > Integer.MAX_VALUE</code> or
   *         <code>value = NaN</code>
  ...
  public static Fraction getFraction(double value) {
    ...
    do {
      ...
      // System.out.println(numer2 + " " + denom2 + " " + fraction + " " + delta2 + " " +
      // y1);
      a1 = a2;
      x1 = x2;
      y1 = y2;
      ...
      denom1 = denom2;
      i++;
      // System.out.println(">>" + delta1 +" "+ delta2+" "+(delta1 > delta2)+" "+i+"
      // "+denom2);
   ...
   * 
   * <p>
   * This method may return a value greater than the denominator, an improper fraction,
   * such as the seven in 7/4.
   * </p>
   * 
   ...
   * 
   * <p>
   * An improper fraction 7/4 can be resolved into a proper one, 1 3/4. This method
   * returns the 3 from the proper fraction.
   * </p>
   * 
   * <p>
   * If the fraction is negative such as -7/4, it can be resolved into -1 3/4, so this
   * method returns the positive proper numerator, 3.
   * </p>
   * 
   ...
   * <p>
   * An improper fraction 7/4 can be resolved into a proper one, 1 3/4. This method
   * returns the 1 from the proper fraction.
   * </p>
   * 
   * <p>
   * If the fraction is negative such as -7/4, it can be resolved into -1 3/4, so this
   * method returns the positive whole part -1.
   * </p>
   * 
  ...
  /**
   * <p>
   * Gets the fraction as an <code>int</code>. This returns the whole number part of the
   * fraction.
   * </p>
   * 
  ...
  /**
   * <p>
   * Gets the fraction as a <code>long</code>. This returns the whole number part of the
   * fraction.
   * </p>
   * 
   * @return the whole number fraction part
  ...
  /**
   * <p>
   * Gets the fraction as a <code>float</code>. This calculates the fraction as the
  ...
  /**
   * <p>
   * Gets the fraction as a <code>double</code>. This calculates the fraction as the
   * numerator divided by denominator.
   * </p>
   * 
   ...
   * </p>
   * 
   * @return <code>this</code> if it is positive, or a new positive fraction instance with
   *         the opposite signed numerator
   */
  public Fraction abs() {
    if (numerator >= 0) {
      return this;
   ...
   * @return <code>this</code> if the power is one, <code>ONE</code> if the power is zero
   *         (even if the fraction equals ZERO) or a new fraction instance raised to the
   *         appropriate power
  ...
  /**
   * <p>
   * Gets the greatest common divisor of the absolute value of two numbers, using the
   * "binary gcd" method which avoids division and modulo operations. See Knuth 4.5.2
  ...
  /**
   * <p>
   * Subtracts the value of another fraction from the value of this one, returning the
   ...
   * @return a <code>Fraction</code> instance with the resulting values
   * @throws IllegalArgumentException if the fraction is <code>null</code>
   * @throws ArithmeticException if the resulting numerator or denominator cannot be
  ...
  private Fraction addSub(Fraction fraction, boolean isAdd) {
    ...
    if (d1 == 1) {
      ...
      return new Fraction(isAdd ? addAndCheck(uvp, upv) : subAndCheck(uvp, upv), mulPosAndCheck(
  ...
  /**
   * <p>
   * Multiplies the value of this fraction by another, returning the result in reduced
   * form.
   * </p>
   * 
   ...
   * 
   * <p>
   * Note: this class has a natural ordering that is inconsistent with equals, because,
   * for example, equals treats 1/2 and 2/4 as different, whereas compareTo treats them as
   * equal.
   * 
  ...
  public String toString() {
    if (toString == null) {
      toString = new StringBuilder(32).append(getNumerator()).append('/').append(getDenominator())
          .toString();
    }
    return toString;
  }
   ...
   * 
   * <p>
   * The format used in '<i>wholeNumber</i> <i>numerator</i>/<i>denominator</i>'. If the
   * whole number is zero it will be ommitted. If the numerator is zero, only the whole
   * number is returned.
   * </p>
   * 
   * @return a <code>String</code> form of the fraction
    ...
    if (toProperString == null) {
      if (numerator == 0) {
        ...
        if (properNumerator == 0) {
          ...
          toProperString = new StringBuilder(32).append(getProperWhole()).append(' ').append(
              properNumerator).append('/').append(getDenominator()).toString();
        }
      } else {
        toProperString = new StringBuilder(32).append(getNumerator()).append('/').append(
