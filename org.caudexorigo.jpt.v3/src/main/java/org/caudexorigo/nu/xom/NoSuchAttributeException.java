...
/**
 * <p>
 * Indicates that an attribute with a certain name and/or namespace does not exist. This
 * is normally thrown after an attempt to remove such a non-existent attribute.
 * </p>
 * 
...
public class NoSuchAttributeException extends XMLException {
  ...
  /**
   * <p>
   * Creates a new <code>NoSuchAttributeException</code> with a detail message.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a new <code>NoSuchAttributeException</code> with the specified detail message
