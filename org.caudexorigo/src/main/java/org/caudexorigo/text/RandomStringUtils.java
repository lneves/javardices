...
public class RandomStringUtils {
  ...
  /**
   * <p>
   * Random object used by random method. This has to be not local to the random method so
   * as to not return the same value in the same millisecond.
   * </p>
   */
   ...
   * externally supplied source of randomness, it uses the internal static {@link Random}
   * instance.
   * </p>
   * 
   * @param count the length of random string to create
   ...
   * it for each call, the same random sequence of strings can be generated repeatedly and
   * predictably.
   * </p>
   * 
   * @param count the length of random string to create
