...
public class StandardToStringStyle extends ToStringStyle
{
	...
	/**
	 * <p>
	 * Gets the text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is output.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Sets the start text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is output.
	 * </p>
	 * 
	 * <p>
	 * This is output before the size value.
	...
	/**
	 * Gets the end text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is output.</p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Sets the end text to output when a <code>Collection</code>, <code>Map</code> or <code>Array</code> size is output.
	 * </p>
	 * 
	 * <p>
	 * This is output after the size value.
