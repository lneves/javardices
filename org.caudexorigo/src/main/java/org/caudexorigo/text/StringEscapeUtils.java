...
public class StringEscapeUtils {
  ...
  /**
   * <p>
   * <code>StringEscapeUtils</code> instances should NOT be constructed in standard
   * programming.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Escapes the characters in a <code>String</code> using Java String rules to a
   * <code>Writer</code>.
   * </p>
   * 
   * <p>
   ...
   * </p>
   * <p>
   * Escapes any values it finds into their JavaScript String form. Deals correctly with
  ...
  /**
   * <p>
   * Escapes the characters in a <code>String</code> using JavaScript String rules to a
   * <code>Writer</code>.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Unescapes any Java literals found in the <code>String</code>. For example, it will
   * turn a sequence of <code>'\'</code> and <code>'n'</code> into a newline character,
   * unless the <code>'\'</code> is preceded by another <code>'\'</code>.
   * </p>
   * 
   ...
   * 
   * <p>
   * For example, it will turn a sequence of <code>'\'</code> and <code>'n'</code> into a
   ...
   * 
   * <p>
   * Supports all known HTML 4.0 entities, including funky accents. Note that the commonly
   * used apostrophe escape character (&amp;apos;) is not a legal entity and so is not
   * supported).
   * </p>
   * 
   ...
   *      Entities</a>
   * @see <a href="http://www.w3.org/TR/REC-html32#latin1">HTML 3.2 Character Entities for
   *      ISO Latin-1</a>
  ...
  /**
   * <p>
   * Escapes the characters in a <code>String</code> using HTML entities and writes them
   ...
   * @throws IOException when <code>Writer</code> passed throws the exception from calls
   *         to the {@link Writer#write(int)} methods.
   * 
   ...
   * 
   * <p>
   * If an entity is unrecognized, it is left alone, and inserted verbatim into the result
   ...
   * 
   * <p>
   * Supports only the five basic XML entities (gt, lt, quot, amp, apos). Does not support
   * DTDs or external entities.
   * </p>
   * 
   * <p>
   ...
   * characters. This may change in future releases.
   * </p>
   * 
   * @param writer the writer receiving the unescaped string, not null
   * @param str the <code>String</code> to unescape, may be null
  ...
  /**
   * <p>
   * Escapes the characters in a <code>String</code> to be suitable to pass to an SQL
   * query.
   * </p>
   * 
   * <p>
   ...
   * 
   * <pre>
   * statement.executeQuery(&quot;SELECT * FROM MOVIES WHERE TITLE='&quot; + StringEscapeUtils.escapeSql(
   *     &quot;McHale's Navy&quot;) + &quot;'&quot;);
   * </pre>
   * 
   * </p>
   ...
   * (<code>"McHale's Navy"</code> => <code>"McHale''s Navy"</code>). It does not handle
