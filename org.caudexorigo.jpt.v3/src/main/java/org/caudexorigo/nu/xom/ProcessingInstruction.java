...
/**
 * <p>
 * This class represents an XML processing instruction. Each processing instruction has
 * two key properties:
 * </p>
 * 
 * <ul>
 * <li>The target, a non-colonized name</li>
 * <li>The data, a string which does not contain the two character sequence
 * <code>?&gt;</code>. The syntax of the data depends completely on the processing
 * instruction. Other than forbidding <code>?&gt;</code>, XML defines no rules for
 * processing instruction data.</li>
 * </ul>
 * 
...
public class ProcessingInstruction extends Node {
   ...
   * 
   * @throws IllegalTargetException if the target is not a non-colonized name or is the
   *         string "xml" in any case
   * @throws IllegalDataException if data contains "?>" or any other illegal characters
   */
   ...
   * 
   * @throws IllegalTargetException if the proposed target is not an XML 1.0 non-colonized
   *         name or is the string "xml" in any case
   */
   ...
   * 
   * @throws IllegalDataException if <code>data</code> is null or otherwise not legal XML
  ...
  /**
   * <p>
   * Throws <code>IndexOutOfBoundsException</code> because processing instructions do not
   * have children.
   * </p>
   * 
   * @return never returns because processing instructions do not have children; always
   *         throws an exception.
   * 
   * @param position the index of the child node to return
   * 
   * @throws IndexOutOfBoundsException because processing instructions do not have
   *         children
   */
  ...
  /**
   * <p>
   * Returns the actual XML form of this processing instruction, such as might be copied
   * and pasted from the original document.
   * </p>
   * 
   * @return an XML representation of this processing instruction as a <code>String</code>
   */
  ...
  /**
   * <p>
   * Returns a deep copy of this processing instruction with no parent, that can be added
   * to this document or a different one.
   * </p>
   * 
   * @return a copy of this <code>ProcessingInstruction</code> with no parent
   */
  public Node copy() {
  ...
  /**
   * <p>
   * Returns a <code>String</code> representation of this processing instruction suitable
   * for debugging and diagnosis. This is <em>not</em> the XML representation of this
   * processing instruction.
   * </p>
   * 
   * @return a non-XML string representation of this <code>ProcessingInstruction</code>
   */
