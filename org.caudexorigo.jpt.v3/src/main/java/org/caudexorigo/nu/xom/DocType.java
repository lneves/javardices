...
/**
 * <p>
 * Represents an XML document type declaration such as <code>&lt;!DOCTYPE book SYSTEM "docbookx.dtd"></code>. Note that this is not the same thing as a document type <em>definition</em> (DTD). XOM does not currently model the DTD. The document type declaration contains or points to the DTD, but it is not the DTD.
 * </p>
 * 
 * <p>
 * A <code>DocType</code> object does not have any child nodes. It can be a child of a <code>Document</code>.
 * </p>
 * 
 * <p>
 * Each <code>DocType</code> object has four <Code>String</code> properties, some of which may be null:
 * </p>
 * 
 * <ul>
 * <li>The declared name of the root element (which does not necessarily match the actual root element name in an invalid document)</li>
...
public class DocType extends Node
{
	...
	/**
	 * <p>
	 * Creates a new document type declaration with a public ID and a system ID. It has the general form <code>&lt;!DOCTYPE rootElementName PUBLIC 
	 ...
	 *             if <code>rootElementName</code> is not a legal XML 1.0 name
	 * @throws IllegalDataException
	 *             if <code>publicID</code> is not a legal XML 1.0 public identifier
	...
	/**
	 * <p>
	 * Creates a new document type declaration with a system ID but no public ID. It has the general form <code>&lt;!DOCTYPE rootElementName SYSTEM "systemID"&gt;</code>.
	 * </p>
	 * 
	 * @param rootElementName
	 *            the name specified for the root element
	...
	/**
	 * <p>
	 * Creates a new document type declaration with no public or system ID. It has the general form <code>&lt;!DOCTYPE rootElementName&gt;</code>.
	 * </p>
	 * 
	 * @param rootElementName
	 *            the name specified for the root element
	...
	/**
	 * <p>
	 * Creates a new <code>DocType</code> that's a copy of its argument. The copy has the same data but no parent document.
	 * </p>
	 * 
	 * @param doctype
	 *            the <code>DocType</code> to copy
	 */
	 ...
	 * 
	 * @param name
	 *            the root element name given by the document type declaration
	 * 
	 * @throws IllegalNameException
	 ...
	 * 
	 * @throws IllegalDataException
	 *             if subset is not a legal XML 1.0 internal DTD subset
	 * 
	 * @since 1.1
	 */
	 ...
	 * 
	 * @throws IllegalDataException
	 *             if the public ID does not satisfy the rules for public IDs in XML 1.0
	...
	/**
	 * <p>
	 * Sets the system ID for the external DTD subset. This must be a a relative or absolute URI with no fragment identifier. Passing null removes the system ID, but only if the public ID has been removed first. Otherwise, passing null causes a <code>WellformednessException</code>.
	 * </p>
	 * 
	 * @param id
	 *            the URL of the external DTD subset
	...
	/**
	 * <p>
	 * Throws <code>IndexOutOfBoundsException</code> because document type declarations do not have children.
	 * </p>
	 * 
	 * @return never returns because document type declarations do not have children. Always throws an exception.
	 * 
	 * @param position
	...
	/**
	 * <p>
	 * Returns a string form of the <code>DocType</code> suitable for debugging and diagnosis. It deliberately does not return an actual XML document type declaration.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a copy of this <code>DocType</code> which has the same system ID, public ID, root element name, and internal DTD subset, but does not belong to a document. Thus, it can be inserted into a different document.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a string containing the actual XML form of the document type declaration represented by this object. For example, <code>&lt;!DOCTYPE book SYSTEM "docbookx.dtd"></code>.
	 * </p>
	 * 
