...
public class DbFetcher<T> {
  ...
  public T fetchObject(final Db db, final String sql, final RowConverter<T> extractor,
      Object... params) {
    PreparedStatement ps = null;
  ...
  public T fetchObject(final Db db, final PreparedStatement pstmt, final RowConverter<T> extractor,
      Object... params) {
    ResultSet rs = null;
