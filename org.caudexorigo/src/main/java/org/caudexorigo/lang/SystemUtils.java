 ...
 * 
 * <p>
 * If a system property cannot be read due to security restrictions, the corresponding
 * field in this class will be set to <code>null</code> and a message will be written to
...
public class SystemUtils {
   ...
   * 
   * <p>
   * Defaults to <code>null</code> if the runtime does not have security access to read
   ...
   * {@link System#setProperties(java.util.Properties)} is called after this class is
  ...
  /**
   * <p>
   * The <code>java.awt.headless</code> System Property. The value of this property is the
  ...
  /**
   * <p>
   * The <code>java.class.version</code> System Property. Java class format version
   * number.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * The <code>java.compiler</code> System Property. Name of JIT compiler to use. First in
   * JDK version 1.2. Not used in Sun JDKs after 1.2.
   * </p>
   * 
   * <p>
   * Defaults to <code>null</code> if the runtime does not have security access to read
  ...
  /**
   * <p>
   * The <code>java.library.path</code> System Property. List of paths to search when
   * loading libraries.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * The <code>java.runtime.version</code> System Property. Java Runtime Environment
   * version.
   * </p>
   * 
   * <p>
   ...
   * @since Java 1.2
   */
  public static final String JAVA_SPECIFICATION_VENDOR = getSystemProperty(
  ...
  /**
   * <p>
   * The <code>java.vm.info</code> System Property. Java Virtual Machine implementation
   * info.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * The <code>java.vm.name</code> System Property. Java Virtual Machine implementation
   * name.
   * </p>
   * 
   * <p>
   ...
   * @since Java 1.2
   */
  public static final String JAVA_VM_SPECIFICATION_NAME = getSystemProperty(
  ...
  /**
   * <p>
   * The <code>user.country</code> or <code>user.region</code> System Property. User's
   * country code, such as <code>GB</code>. First in JDK version 1.2 as
  ...
  /**
   * <p>
   * The <code>user.language</code> System Property. User's language code, such as
   * <code>"en"</code>.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Is <code>true</code> if this is a POSIX compilant system, as in any of AIX, HP-UX,
  ...
  /**
   * <p>
   * SystemUtils instances should NOT be constructed in standard programming. Instead, the
   * class should be used as <code>SystemUtils.FILE_SEPARATOR</code>.
   * </p>
   * 
   * <p>
   ...
   * @deprecated Use {@link #JAVA_VERSION_FLOAT} instead. Method will be removed in
   *             Commons Lang 3.0.
   */
   ...
   * 
   * <p>
   * Patch releases are not reported. Zero is returned if {@link #JAVA_VERSION_TRIMMED} is
   * <code>null</code>.
   * </p>
   * 
   * @return the version, for example 1.31f for JDK 1.3.1
  ...
  /**
   * <p>
   * Gets a System property, defaulting to <code>null</code> if the property cannot be
   * read.
   * </p>
   * 
   * <p>
   * If a <code>SecurityException</code> is caught, the return value is <code>null</code>
   * and a message is written to <code>System.err</code>.
   * </p>
   * 
