...
import org.caudexorigo.lang.BooleanUtils;
 ...
 * 
 * <p>
 * This class enables a good and consistent <code>toString()</code> to be built for any
 ...
 * Because these fields are usually private, the method, <code>reflectionToString</code>,
...
public class ToStringBuilder {
   ...
   * 
   * <p>
   * This could allow the <code>ToStringStyle</code> to be controlled for an entire
   * application with one call.
   * </p>
   * 
   * <p>
   * This might be used to have a verbose <code>ToStringStyle</code> during development
   * and a compact <code>ToStringStyle</code> in production.
   * </p>
   * 
  ...
  public static String reflectionToString(Object object, ToStringStyle style,
    ...
    return ReflectionToStringBuilder.toString(object, style, outputTransients, false,
        reflectUpToClass);
  }
  ...
  /**
   * <p>
   * Constructor for <code>ToStringBuilder</code> specifying the output style.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * A boolean parameter controls the level of detail to show. Setting <code>true</code>
   * will output the array in full. Setting <code>false</code> will output a summary,
  ...
  public ToStringBuilder appendAsObjectToString(Object object) {
    ObjectUtils.appendIdentityToString(this.getStringBuilder(), object);
    return this;
  }
   ...
   * 
   * <p>
   * This method assumes that the superclass uses the same <code>ToStringStyle</code> as
   * this one.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * This method is useful where a class delegates most of the implementation of its
   * properties to another class. You can then call <code>toString()</code> on the other
   ...
   * 
   * <p>
   * This method assumes that the other object uses the same <code>ToStringStyle</code> as
   * this one.
   * </p>
   * 
   * <p>
