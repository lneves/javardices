 ...
 * thrown for a <code>null</code> input. Each method documents its behaviour in more
 * detail.
 * </p>
 * 
...
public class BooleanUtils {
  ...
  /**
   * <p>
   * Checks if a <code>Boolean</code> value is <i>not</i> <code>true</code>, handling
   * <code>null</code> by returning <code>true</code>.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Checks if a <code>Boolean</code> value is <i>not</i> <code>false</code>, handling
   * <code>null</code> by returning <code>true</code>.
   * </p>
   * 
   * <pre>
   ...
   * 
   * @param value the int to convert
   * @return Boolean.TRUE if non-zero, Boolean.FALSE if zero, <code>null</code> if
   *         <code>null</code>
   */
  ...
  /**
   * <p>
   * Converts an Integer to a Boolean using the convention that <code>zero</code> is
   * <code>false</code>.
   * </p>
   * 
   * <p>
   ...
   * @throws IllegalArgumentException if no match
   */
  public static Boolean toBooleanObject(Integer value, Integer trueValue, Integer falseValue,
      Integer nullValue) {
    if (value == null) {
      if (trueValue == null) {
        return Boolean.TRUE;
  ...
  /**
   * <p>
   * Converts a boolean to an Integer using the convention that <code>zero</code> is
   * <code>false</code>.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Converts a Boolean to a Integer using the convention that <code>zero</code> is
   * <code>false</code>.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * <code>'true'</code>, <code>'on'</code> or <code>'yes'</code> (case insensitive) will
   * return <code>true</code>. <code>'false'</code>, <code>'off'</code> or
   * <code>'no'</code> (case insensitive) will return <code>false</code>. Otherwise,
   ...
   * 
   * @param str the String to check
   * @param trueString the String to match for <code>true</code> (case sensitive), may be
   *        <code>null</code>
   * @param falseString the String to match for <code>false</code> (case sensitive), may
   *        be <code>null</code>
   * @param nullString the String to match for <code>null</code> (case sensitive), may be
   *        <code>null</code>
   * @return the Boolean value of the string, <code>null</code> if either the String
   *         matches <code>nullString</code> or if <code>null</code> input and
   *         <code>nullString</code> is <code>null</code>
   * @throws IllegalArgumentException if the String doesn't match
   */
  public static Boolean toBooleanObject(String str, String trueString, String falseString,
      String nullString) {
    if (str == null) {
      if (trueString == null) {
        return Boolean.TRUE;
   ...
   * <code>Boolean.valueOf(String)</code>. However, this method accepts 'on' and 'yes' as
   * true values.
   * 
   * <pre>
   *   BooleanUtils.toBoolean(null)    = false
  ...
  public static boolean toBoolean(String str) {
    ...
    switch (str.length()) {
      ...
      case 3: {
        ...
        if (ch == 'y') {
          return (str.charAt(1) == 'e' || str.charAt(1) == 'E') && (str.charAt(2) == 's' || str
              .charAt(2) == 'S');
        }
        if (ch == 'Y') {
          return (str.charAt(1) == 'E' || str.charAt(1) == 'e') && (str.charAt(2) == 'S' || str
      ...
      case 4: {
        char ch = str.charAt(0);
        if (ch == 't') {
          return (str.charAt(1) == 'r' || str.charAt(1) == 'R') && (str.charAt(2) == 'u' || str
              .charAt(2) == 'U') && (str.charAt(3) == 'e' || str.charAt(3) == 'E');
        }
        if (ch == 'T') {
          return (str.charAt(1) == 'R' || str.charAt(1) == 'r') && (str.charAt(2) == 'U' || str
              .charAt(2) == 'u') && (str.charAt(3) == 'E' || str.charAt(3) == 'e');
  ...
  /**
   * <p>
   * Converts a Boolean to a String returning <code>'true'</code>, <code>'false'</code>,
   * or <code>null</code>.
   * </p>
   * 
   * <pre>
