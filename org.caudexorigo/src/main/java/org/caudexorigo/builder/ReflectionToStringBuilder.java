...
public class ReflectionToStringBuilder extends ToStringBuilder
{
	 ...
	 * 
	 * <p>
	 * If the <code>outputTransients</code> is <code>true</code>, transient members will be output, otherwise they are ignored, as they are likely derived fields, and not part of the value of the Object.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * If the <code>outputTransients</code> is <code>true</code>, transient fields will be output, otherwise they are ignored, as they are likely derived fields, and not part of the value of the Object.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * Static fields will not be included. Superclass fields will be appended up to and including the specified superclass. A null superclass is treated as <code>java.lang.Object</code>.
	 * </p>
	 * 
	 * <p>
	 * If the style is <code>null</code>, the default <code>ToStringStyle</code> is used.
	 ...
	 * Constructor.
	 * 
	 * @deprecated Use {@link #ReflectionToStringBuilder(Object,ToStringStyle,StringBuilder,Class,boolean,boolean)}.
	 * 
	 * @param object
	 *            the Object to build a <code>toString</code> for
	 * @param style
	 ...
	 *            whether to include transient fields
	 */
	public ReflectionToStringBuilder(Object object, ToStringStyle style, StringBuilder buffer, Class reflectUpToClass, boolean outputTransients)
	{
		super(object, style, buffer);
	 ...
	 * @since 2.1
	 */
	public ReflectionToStringBuilder(Object object, ToStringStyle style, StringBuilder buffer, Class reflectUpToClass, boolean outputTransients, boolean outputStatics)
	{
		super(object, style, buffer);
		this.setUpToClass(reflectUpToClass);
		this.setAppendTransients(outputTransients);
	 ...
	 * 
	 * <p>
	 * If a cycle is detected as an object is &quot;toString()'ed&quot;, such an object is rendered as if <code>Object.toString()</code> had been called and not implemented by the object.
	 * </p>
	 * 
	 * @param clazz
