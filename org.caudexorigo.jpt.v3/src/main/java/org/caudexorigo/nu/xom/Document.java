...
/**
 * <p>
 * The <code>Document</code> class represents a complete XML document including its root
 * element, prolog, and epilog.
 * </p>
 * 
...
public class Document extends ParentNode {
  ...
  /**
   * <p>
   * Creates a new <code>Document</code> object with the specified root element.
   * </p>
   * 
   * @param root the root element of this document
   * 
   * @throws NullPointerException if <code>root</code> is null
   * @throws MultipleParentException if <code>root</code> already has a parent
   */
  ...
  /**
   * <p>
   * Sets this document's document type declaration. If this document already has a
   * document type declaration, then it's inserted at that position. Otherwise, it's
   * inserted at the beginning of the document.
   * </p>
   * 
   * @param doctype the document type declaration
   * 
   * @throws MultipleParentException if <code>doctype</code> belongs to another document
  ...
  /**
   * <p>
   * Sets the URI from which this document was loaded, and against which relative URLs in
   * this document will be resolved. Setting the base URI to null or the empty string
   * removes any existing base URI.
   * </p>
   * 
   * @param URI the base URI of this document
   * 
   * @throws MalformedURIException if <code>URI</code> is not a legal absolute URI
   */
  ...
  /**
   * <p>
   * Returns the absolute URI from which this document was loaded. This method returns the
   * empty string if the base URI is not known; for instance if the document was created
   * in memory with a constructor rather than by parsing an existing document.
   * </p>
   * 
  ...
  /**
   * <p>
   * Removes the child of this document at the specified position. Indexes begin at 0 and
   * count up to one less than the number of children of this document. The root element
   * cannot be removed. Instead, use <code>setRootElement</code> to replace the existing
   * root element with a different element.
   * </p>
   * 
   ...
   *         of children of this document - 1
  ...
  /**
   * <p>
   * Removes the specified child from this document. The root element cannot be removed.
   * Instead, use <code>setRootElement</code> to replace the existing root element with a
   * different element.
   * </p>
   * 
   ...
   * @return the node which was removed
   * 
   * @throws NoSuchChildException if the node is not a child of this node
   ...
   * child of this node, then a <code>NoSuchChildException</code> is thrown. The root
   * element can only be replaced by another element.
   * </p>
   * 
   ...
   * @throws IllegalAddException if <code>newChild</code> is an attribute or a text node
   * @throws WellformednessException if <code>newChild</code> <code>oldChild</code> is an
   *         element and <code>newChild</code> is not
   */
  ...
  /**
   * <p>
   * Returns the value of the document as defined by XPath 1.0. This is the same as the
   * value of the root element, which is the complete PCDATA content of the root element,
   * without any tags, comments, or processing instructions after all entity and character
  ...
  /**
   * <p>
   * Returns the actual complete, well-formed XML document as a <code>String</code>.
   * Significant white space is preserved. Insignificant white space in tags, the prolog,
   * the epilog, and the internal DTD subset is not preserved. Entity and character
   * references are not preserved. The entire document is contained in this one string.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns a string representation of this document suitable for debugging and
   * diagnosis. This is <em>not</em> the XML representation of this document.
   * </p>
   * 
