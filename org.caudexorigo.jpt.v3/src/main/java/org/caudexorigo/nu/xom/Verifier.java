...
/**
 * <p>
 * <code>Verifier</code> checks names and data for compliance with XML 1.0 and Namespaces in XML rules.
 * </p>
 * 
...
final class Verifier
{
	...
	private static void loadFlags(ClassLoader loader)
	{
		...
		try
		{
			...
			if (raw == null)
			{
				throw new RuntimeException("Broken XOM installation: could not load org/caudexorigo/nu/xom/characters.dat");
			}
			// buffer this????
	...
	/**
	 * <p>
	 * Check whether <code>name</code> is a non-colonized name as defined in <cite>Namespaces in XML</cite>.
	 * </p>
	 * 
	 * @param name
	 ...
	 *             if <code>name</code> is not a non-colonized name
	 */
	 ...
	 *
	 * @param text
	 *            <code>String</code> value to verify
	 * 
	 * @throws IllegalCharacterDataException
	 *             if <code>text</code> is not legal PCDATA
	 */
	 ...
	 * 
	 * @param uri
	 *            <code>String</code> containing the potential URI
	 * 
	 * @throws MalformedURIException
	 *             if this is not a legal URI reference
	 */
	...
	static boolean isSchemeCharacter(char c)
	{
		...
		/*
		 * The : and the ? cannot be reached here because they'll have been parsed out separately before this method is called. They're included here strictly for alignment so the compiler will generate a table lookup.
		 */
		switch (c)
		{
		case '+':
	...
	/**
	 * Check to see that this string is an absolute URI, neither a relative URI nor a URI reference.
	 * 
	 */
