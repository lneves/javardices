...
class Entities {
  ...
  static class LookupEntityMap extends PrimitiveEntityMap {
    ...
    /**
     * <p>
     * Returns the lookup table for this entity map. The lookup table is created if it has
     * not been previously.
     * </p>
     * 
    ...
    /**
     * <p>
     * Creates an entity lookup table of LOOKUP_TABLE_SIZE elements, initialized with
     * entity names.
     * </p>
     */
  ...
  static class BinaryEntityMap extends ArrayEntityMap {
    ...
    /**
     * Constructs a new instance of <code>ArrayEntityMap</code> specifying the size by
     * which the underlying array should grow.
     * 
     * @param growBy array will be initialized to and will grow by this amount
     */
    ...
    /**
     * Performs a binary search of the entity array for the specified key. This method is
     * based on code in {@link java.util.Arrays}.
     * 
  ...
  /**
   * <p>
   * Unescapes the escaped entities in the <code>String</code> passed and writes the
    ...
    for (int i = 0; i < len; i++) {
      ...
      if (c == '&') {
        ...
        if (entityContentLen > 0) {
          if (entityContent.charAt(0) == '#') { // escaped value content is an integer
                                                // (decimal or
                                                // hexidecimal)
