...
public final class LongRange extends Range implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>LongRange</code> using the specified number as both the
  ...
  /**
   * <p>
   * Constructs a new <code>LongRange</code> with the specified minimum and maximum
  ...
  /**
   * <p>
   * Tests whether the specified range overlaps with this range using <code>long</code>
   * comparison.
   * </p>
   * 
   * <p>
  ...
  public boolean overlapsRange(Range range) {
    ...
    return range.containsLong(min) || range.containsLong(max) || containsLong(range
        .getMinimumLong());
  }
