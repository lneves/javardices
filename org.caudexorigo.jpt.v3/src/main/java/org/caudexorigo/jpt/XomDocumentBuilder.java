...
public final class XomDocumentBuilder {
  ...
  private static XMLReader getParser() {
    try {
      ...
      setParserFeature(reader0, "http://apache.org/xml/features/nonvalidating/load-external-dtd",
          true);
      setParserFeature(reader0, "http://apache.org/xml/features/nonvalidating/load-dtd-grammar",
          false);
  ...
  public static Document getDocument(InputStream in) throws ValidityException, ParsingException,
      IOException {
    synchronized (reader) {
      if (reader == null) {
  ...
  public static Document getDocument(URI templateUri) throws ValidityException, ParsingException,
      IOException {
  ...
  private static InputStream uri2InputStream(URI templateUri) throws IOException,
