...
/**
 * <p>
 * Indicates an attempt to add a node in a wrong place; for instance adding a <code>Text</code> node to a <code>Document</code> object.
 * </p>
 * 
...
public class IllegalAddException extends WellformednessException
{
	...
	/**
	 * <p>
	 * Creates a new <code>IllegalAddException</code> with a detail message and an underlying root cause.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
