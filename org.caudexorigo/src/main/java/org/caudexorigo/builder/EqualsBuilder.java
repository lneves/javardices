 ...
 *   return new EqualsBuilder().appendSuper(super.equals(obj)).append(field1, rhs.field1).append(
 *       field2, rhs.field2).append(field3, rhs.field3).isEquals();
 * }
 * </pre>
 * 
 * <p>
...
public class EqualsBuilder {
   ...
   * 
   * <p>
   * Transient members will be not be tested, as they are likely derived fields, and not
