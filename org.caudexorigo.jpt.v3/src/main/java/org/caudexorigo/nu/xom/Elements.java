 ...
 * 
 * <p>
 * A read-only list of elements for traversal purposes. Changes to the document from which
 * this list was generated are not reflected in this list. Changes to the individual
...
public final class Elements {
  ...
  /**
   * <p>
   * Returns the index<sup>th</sup> element in the list. The first element has index 0.
   * The last element has index <code>size()-1</code>.
   * </p>
   * 
