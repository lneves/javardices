...
public final class DoubleRange extends Range implements Serializable
{
	...
	/**
	 * <p>
	 * Constructs a new <code>DoubleRange</code> using the specified number as both the minimum and maximum in this range.
	 * </p>
	 * 
	 * @param number
	...
	/**
	 * <p>
	 * Constructs a new <code>DoubleRange</code> with the specified minimum and maximum numbers (both inclusive).
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Tests whether the specified range occurs entirely within this range using <code>double</code> comparison.
	 * </p>
	 * 
	 * <p>
	 * <code>null</code> is handled and returns <code>false</code>.
	...
	/**
	 * <p>
	 * Tests whether the specified range overlaps with this range using <code>double</code> comparison.
	 * </p>
	 * 
	 * <p>
	 * <code>null</code> is handled and returns <code>false</code>.
