...
/**
 * <p>
 * Indicates an attempt to set some value to malformed content; for instance by adding a
 * string containing a null or a vertical tab to a text node, or using white space in an
 * element name.
 * </p>
 * 
...
public class IllegalDataException extends WellformednessException {
  ...
  /**
   * <p>
   * Creates a new <code>IllegalDataException</code> with a detail message.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a new <code>IllegalDataException</code> with a detail message and an
   ...
   * </p>
   * 
   * @return the syntactically incorrect data that caused this exception
   */
