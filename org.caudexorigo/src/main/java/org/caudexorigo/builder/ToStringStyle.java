...
/**
 * <p>
 * Controls <code>String</code> formatting for {@link ToStringBuilder}. The main public
 * interface is always via <code>ToStringBuilder</code>.
 * </p>
 * 
 * <p>
 * These classes are intended to be used as <code>Singletons</code>. There is no need to
 * instantiate a new style each time. A program will generally use one of the predefined
 * constants on this class. Alternatively, the {@link StandardToStringStyle} class can be
 * used to set the individual settings. Thus most styles can be achieved without
 * subclassing.
 * </p>
 * 
 * <p>
 * If required, a subclass can override as many or as few of the methods as it requires.
 * Each object type (from <code>boolean</code> to <code>long</code> to <code>Object</code>
 * to <code>int[]</code>) has its own methods to output it. Most have two versions, detail
 * and summary.
 * 
 * <p>
 * For example, the detail version of the array based methods will output the whole array,
 * whereas the summary method will just output the array length.
 * </p>
 * 
 * <p>
 * If you want to format the output of certain objects, such as dates, you must create a
...
public abstract class ToStringStyle implements Serializable {
  ...
  /**
   * The no field names toString style. Using the Using the <code>Person</code> example
  ...
  /**
   * <p>
   * Append to the <code>toString</code> an <code>Object</code>, correctly interpreting
   * its type.
   * </p>
   * 
   * <p>
   * This method performs the main lookup by Class type to correctly route arrays,
   * <code>Collections</code>, <code>Maps</code> and <code>Objects</code> to the
   * appropriate method.
   * </p>
   * 
   * <p>
   ...
   */
  protected void appendInternal(StringBuilder buffer, String fieldName, Object value,
      boolean detail) {
  ...
  /**
   * <p>
   * Append to the <code>toString</code> an <code>Object</code> value that has been
   ...
   * <p>
   * Append to the <code>toString</code> an <code>Object</code> value, printing the full
   * detail of the <code>Object</code>.
   * </p>
   * 
   * @param buffer the <code>StringBuilder</code> to populate
   * @param fieldName the field name, typically not used as already appended
  ...
  /**
   * <p>
   * Append to the <code>toString</code> an <code>Object</code> value, printing a summary
   ...
   * 
   * <p>
   * This method converts a detail request into a detail level. The calling code may
   * request full detail (<code>true</code>), but a subclass might ignore that and always
   * return <code>false</code>. The calling code may pass in <code>null</code> indicating
   * that it doesn't care about the detail level. In this case the default detail level is
   * used.
   * </p>
   * 
   ...
   * @deprecated Use {@link #isUseShortClassName()} Method will be removed in Commons Lang
   *             3.0.
   */
   ...
   * @deprecated Use {@link #setUseShortClassName(boolean)} Method will be removed in
   *             Commons Lang 3.0.
   */
  ...
  /**
   * <p>
   * Gets the start text to output when a <code>Collection</code>, <code>Map</code> or
  ...
  /**
   * <p>
   * Sets the start text to output when a <code>Collection</code>, <code>Map</code> or
   * array size is output.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Gets the end text to output when a <code>Collection</code>, <code>Map</code> or array
   * size is output.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Sets the end text to output when a <code>Collection</code>, <code>Map</code> or array
   * size is output.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * This is an inner class rather than using <code>StandardToStringStyle</code> to ensure
   * its immutability.
   * </p>
   */
  ...
  /**
   * <p>
   * <code>ToStringStyle</code> that does not print out the classname, identity hashcode,
