...
public class TestRouting {
  ...
  public static void main(String[] args) {
    ...
    RoutingManager routingManager = new RoutingManager(reader, "/server/http/wwwroot/",
    ...
    for (int i = 0; i != locations.length; ++i) {
      try {
        ...
        if (action instanceof NettyWebJptAction) {
          ...
          System.out.println(
              "Something went wrong... Expecting an instance of NettyWebJptAction and got "
                  + clazz);
        }
      } catch (Exception e) {
  ...
  public static HttpRequestWrapper getRequestWrapper() {
    HttpRequest request = new HttpRequest() {
      ...
      public void setProtocolVersion(HttpVersion arg0) {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.setProtocolVersion()");
      }
      ...
      public void removeHeader(String arg0) {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.removeHeader()");
      }
      ...
      public HttpVersion getProtocolVersion() {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.getProtocolVersion()");
        return null;
      }
      ...
      public Set<String> getHeaderNames() {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.getHeaderNames()");
        return null;
      }
      ...
      public boolean containsHeader(String arg0) {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.containsHeader()");
        return false;
      }
      ...
      public void clearHeaders() {
        System.out.println(
            "TestRouting.getRequestWrapper().new HttpRequest() {...}.clearHeaders()");
      }
