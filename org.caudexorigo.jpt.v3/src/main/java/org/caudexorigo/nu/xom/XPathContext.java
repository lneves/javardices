...
public final class XPathContext
{
	...
	/**
	 * <p>
	 * Creates a new XPath context that binds the specified prefix to the specified URI. The <code>xml</code> prefix is also bound to the URI <code>http://www.w3.org/XML/1998/namespace</code>.
	 * </p>
	 * 
	 * @param prefix
	 *            the prefix to bind
	...
	/**
	 * <p>
	 * Creates a new XPath context that binds the <code>xml</code> prefix to the URI <code>http://www.w3.org/XML/1998/namespace</code>.
	 * </p>
	 */
	public XPathContext()
	{
	...
	/**
	 * <p>
	 * Binds the specified prefix to the specified namespace URI. If the prefix is already bound in this context, the new URI replaces the old URI. Binding a prefix to null removes the declaration. The binding of the <code>xml</code> prefix may not be changed.
	 * </p>
	 * 
	 * @param prefix
	 *            the prefix to bind
	 ...
	 *             if the prefix is <code>xml</code> and the URI is not <code>http://www.w3.org/XML/1998/namespace</code> or the prefix is the empty string
	...
	/**
	 * <p>
	 * Creates a new XPath context that contains all the namespace bindings <em>in scope</em> on the element. Changing the prefixes in scope on the element after the context is returned does not change the context.
	 * </p>
	 * 
	 * @param element
	 ...
	 * 
	 * @return the namespace URI associated with the specified prefix in this context or null
	 */
