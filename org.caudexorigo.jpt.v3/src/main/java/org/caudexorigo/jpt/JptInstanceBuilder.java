...
public final class JptInstanceBuilder {
  ...
  public static JptInstance getJptInstance(final JptConfiguration jptConf, final URI templateUri) {
    try {
      final CacheFiller<URI, JptInstance> template_cache_listeners_cf =
          new CacheFiller<URI, JptInstance>() {
  ...
  public static JptInstance getJptInstance(JptConfiguration jptConf, final InputStream instream,
