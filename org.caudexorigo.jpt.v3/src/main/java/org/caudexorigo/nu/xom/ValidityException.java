...
public class ValidityException extends ParsingException
{
	...
	/**
	 * <p>
	 * Creates a new <code>ValidityException</code> with a detail message and an underlying root cause.
	 * </p>
	 * 
	 * @param message
	...
	/**
	 * <p>
	 * Creates a new <code>ValidityException</code> with a detail message and line and column numbers.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
	 * @param lineNumber
	 *            the approximate line number where the problem occurs
	 * @param columnNumber
	...
	/**
	 * <p>
	 * Creates a new <code>ValidityException</code> with a detail message, line and column numbers, and an underlying exception.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
	...
	/**
	 * <p>
	 * Creates a new <code>ValidityException</code> with a detail message, the URI of the document that contained the error, and approximate line and column numbers of the first validity error.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
	...
	/**
	 * <p>
	 * Creates a new <code>ValidityException</code> with a detail message, URI of the document containing the validity error, line and column numbers of the error, and an underlying exception.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
	...
	/**
	 * <p>
	 * Returns a <code>Document</code> object for the document that caused this exception. This is useful if you want notification of validity errors, but nonetheless wish to further process the invalid document.
	 * </p>
	 * 
	 ...
	 *             if <code>n</code> is greater than or equal to the number of errors detected
	 */
	...
	/**
	 * <p>
	 * Returns the column number of the <i>n</i>th validity error. It returns -1 if this is not known. This number may be helpful for debugging, but should not be relied on. Different parsers may set it differently. For instance a problem with an element might be reported using the column of the <code>&lt;</code> or the <code>&gt;</code> of the start-tag
	 * </p>
	 * 
	 * @param n
	 *            the index of the validity error to report
