 ...
 * <li>The data, a string which does not contain the two character sequence <code>?&gt;</code>. The syntax of the data depends completely on the processing instruction. Other than forbidding <code>?&gt;</code>, XML defines no rules for processing instruction data.</li>
 * </ul>
 * 
...
public class ProcessingInstruction extends Node
{
	 ...
	 *             if the target is not a non-colonized name or is the string "xml" in any case
	 ...
	 * 
	 * @throws IllegalDataException
	 *             if <code>data</code> is null or otherwise not legal XML processing instruction data
	 */
	...
	/**
	 * <p>
	 * Throws <code>IndexOutOfBoundsException</code> because processing instructions do not have children.
	 * </p>
	 * 
	 * @return never returns because processing instructions do not have children; always throws an exception.
	 * 
	 * @param position
	...
	/**
	 * <p>
	 * Returns a <code>String</code> representation of this processing instruction suitable for debugging and diagnosis. This is <em>not</em> the XML representation of this processing instruction.
	 * </p>
	 * 
