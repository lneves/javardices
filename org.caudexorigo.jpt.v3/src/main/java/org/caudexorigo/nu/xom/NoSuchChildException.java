...
/**
 * <p>
 * Indicates that a child with a certain name and/or namespace does not exist. This is
 * thrown when you attempt to remove a node from a parent that does not actually have that
 * node as a child.
 * </p>
 * 
...
public class NoSuchChildException extends XMLException {
  ...
  /**
   * <p>
   * Creates a new <code>NoSuchChildException</code> with a detail message.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a new <code>NoSuchChildException</code> with the specified detail message and
