...
/**
 * <p>
 * Signals an attempt to set a namespace in a way that conflicts with an existing
 * namespace; for instance, adding an attribute to an element that has the same prefix as
 * the element but maps it to a different URI.
 * </p>
 * 
...
public class NamespaceConflictException
  ...
  /**
   * <p>
   * Creates a new <code>NamespaceConflictException</code> with a detail message.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a new <code>NamespaceConflictException</code> with a detail message and an
