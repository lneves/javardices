...
public class HttpHelloWorldServerHandler extends ChannelInboundHandlerAdapter
{
	...
	private static final CharSequence CONTENT_TYPE_ENTITY = new AsciiString(HttpHeaderNames.CONTENT_TYPE);
	...
	private static final CharSequence contentLength = new AsciiString(String.valueOf(CONTENT_BUFFER.readableBytes()));
