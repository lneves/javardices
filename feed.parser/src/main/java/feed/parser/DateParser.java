...
public class DateParser {
  ...
  static String[] date_formats = {"EEE, d MMM yy kk:mm:ss z", // RFC822
      ...
      // 16:31:00 ET
      "yyyy-MM-dd kk:mm:ss.0", "-yy-MM", "-yyMM", "yy-MM-dd", "yyyy-MM-dd", "yyyy-MM", "yyyy-D",
      "-yyMM", "yyyyMMdd", "yyMMdd", "yyyy", "yyD"
  ...
  private static final ThreadLocal<SimpleDateFormat[]> sdf_pt_local =
      new ThreadLocal<SimpleDateFormat[]>() {
