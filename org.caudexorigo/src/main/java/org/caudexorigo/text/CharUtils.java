...
public class CharUtils {
   ...
   * 
   * @see <a href=
   *      "http://java.sun.com/docs/books/jls/third_edition/html/lexical.html#101089">JLF:
  ...
  /**
   * <p>
   * <code>CharUtils</code> instances should NOT be constructed in standard programming.
   * Instead, the class should be used as <code>CharUtils.toString('c');</code>.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * For ASCII 7 bit characters, this uses a cache that will return the same Character
   * object each time.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Converts the String to a Character using the first character, returning null for
   * empty Strings.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Converts the Character to a char throwing an exception for <code>null</code>.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Converts the String to a char using the first character, throwing an exception on
   * empty Strings.
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Converts the String to a char using the first character, defaulting the value on
   * empty Strings.
   * </p>
   * 
   * <pre>
   ...
   * 
   * <p>
   * For ASCII 7 bit characters, this uses a cache that will return the same String object
   * each time.
   * </p>
   * 
   * <pre>
