...
ALTER TABLE holding
	ADD INDEX i_h_ca_id_s_symb_dts (h_ca_id, h_s_symb, h_dts),
...
ALTER TABLE trade
	ADD INDEX i_t_ca_id_dts (t_ca_id, t_dts),
	ADD INDEX i_t_s_symb_dts (t_s_symb, t_dts),
...
ALTER TABLE trade_history
	ADD INDEX i_th_t_id_dts (th_t_id, th_dts),
...
ALTER TABLE watch_list ADD CONSTRAINT fk_watch_list_c FOREIGN KEY (wl_c_id) REFERENCES customer (c_id);
...
ALTER TABLE broker ADD CONSTRAINT fk_broker_st FOREIGN KEY (b_st_id) REFERENCES status_type (st_id); 
