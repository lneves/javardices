 ...
 * performance when synchronization is not required. If a synchronized stack is
 * required, you can use the
 * {@link java.util.Collections#synchronizedCollection(java.util.Collection)
 ...
 * Extending <tt>AbstractCollection</tt> instead of <tt>Vector</tt> allows objects of
 * this class to be used interchangably with other collection framework classes
...
public final class Stack<E> extends AbstractCollection<E>
{
	 ...
	 * collection. The items will be pushed on to the stack in their order in the
	 * collection.
	 * 
	 * @param c
	...
	/**
	 * Gets an iterator for elements on the stack. This iterator starts at the bottom
	 * of the stack and proceeds to the top.
	 * 
	...
	/**
	 * Gets an iterator for elements on the stack. The iterator starts at the top of
	 * the stack and proceeds to the bottom of the stack.
	 * 
	 * @return an iterator over stack elements.
	 */
	...
	/**
	 * Iterator that traverses a list in reverse order. It does this by just adapting
	 * the ListIterator of the list.
	 */
