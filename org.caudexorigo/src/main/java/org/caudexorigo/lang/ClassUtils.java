 ...
 * 
 * <p>
 * This class handles invalid <code>null</code> inputs as best it can. Each method
...
public class ClassUtils {
  ...
  /**
   * <p>
   * ClassUtils instances should NOT be constructed in standard programming. Instead, the
   * class should be used as <code>ClassUtils.getShortClassName(cls)</code>.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Gets a <code>List</code> of all interfaces implemented by the given class and its
   * superclasses.
   * </p>
   * 
   * <p>
   * The order is determined by looking through each interface in turn as declared in the
   * source file and following its hierarchy up. Then each superclass is considered in the
   * same way. Later duplicates are ignored, so the order is maintained.
   * </p>
   * 
   * @param cls the class to look up, may be <code>null</code>
   ...
   * <code>null</code> is stored in the <code>List</code>. If the class name in the
   * <code>List</code> is <code>null</code>, <code>null</code> is stored in the output
   * <code>List</code>.
   * </p>
   * 
  ...
  /**
   * <p>
   * Given a <code>List</code> of <code>Class</code> objects, this method converts them
   * into class names.
   * </p>
   * 
   * <p>
   * A new <code>List</code> is returned. <code>null</code> objects will be copied into
   * the returned list as <code>null</code>.
   * </p>
   * 
   ...
   * 
   * <p>
   * This method calls {@link #isAssignable(Class, Class) isAssignable} for each Class
   * pair in the input arrays. It can be used to check if a set of arguments (the first
   * parameter) are suitably compatible with a set of method parameter types (the second
   * parameter).
   * </p>
   * 
   * <p>
   * Unlike the {@link Class#isAssignableFrom(java.lang.Class)} method, this method takes
   * into account widenings of primitive classes and <code>null</code>s.
   * </p>
   * 
   * <p>
   * Primitive widenings allow an int to be assigned to a <code>long</code>,
   * <code>float</code> or <code>double</code>. This method returns the correct result for
   * these cases.
   * </p>
   * 
   * <p>
   ...
   * <code>Class</code> parameter can be converted to the type represented by this
   * <code>Class</code> object via an identity conversion widening primitive or widening
   * reference conversion. See <em><a href="http://java.sun.com/docs/books/jls/">The Java
   * Language Specification</a></em>, sections 5.1.1, 5.1.2 and 5.1.4 for details.
   * </p>
   * 
   ...
   * method returns the correct result for these cases.
   * </p>
   * 
   * <p>
   * <code>Null</code> may be assigned to any reference type. This method will return
  ...
  public static boolean isAssignable(Class cls, Class toClass) {
    ...
    if (cls.isPrimitive()) {
      ...
      if (Integer.TYPE.equals(cls)) {
        return Long.TYPE.equals(toClass) || Float.TYPE.equals(toClass) || Double.TYPE.equals(
            toClass);
      }
      ...
      if (Character.TYPE.equals(cls)) {
        return Integer.TYPE.equals(toClass) || Long.TYPE.equals(toClass) || Float.TYPE.equals(
            toClass) || Double.TYPE.equals(toClass);
      }
      ...
      if (Byte.TYPE.equals(cls)) {
        return Short.TYPE.equals(toClass) || Integer.TYPE.equals(toClass) || Long.TYPE.equals(
            toClass) || Float.TYPE.equals(toClass) || Double.TYPE.equals(toClass);
      }
  ...
  /**
   * <p>
   * Converts the specified primitive Class object to its corresponding wrapper Class
   * object.
   * </p>
   * 
   * <p>
   ...
   * @return an array which contains for each given class, the wrapper class or the
   *         original class if class is not a primitive. <code>null</code> if null input.
   ...
   * 
   * <p>
   * This method is the counter part of <code>primitiveToWrapper()</code>. If the passed
   * in class is a wrapper class for a primitive type, this primitive type will be
   ...
   * 
   * <p>
   * This method invokes <code>wrapperToPrimitive()</code> for each element of the passed
   * in array.
   * </p>
   * 
   * @param classes the class array to convert, may be null or empty
   * @return an array which contains for each given class, the primitive class or
   *         <b>null</b> if the original class is not a wrapper class. <code>null</code>
  ...
  /**
   * Returns the (initialized )class represented by <code>className</code> using the
   * current thread's context class loader. This implementation supports names like
   * "<code>java.lang.String[]</code>" as well as "<code>[Ljava.lang.String;</code>".
   * 
   * @param className the class name
   * @return the class represented by <code>className</code> using the current thread's
  ...
  /**
   * Returns the class represented by <code>className</code> using the current thread's
   * context class loader. This implementation supports names like
   * "<code>java.lang.String[]</code>" as well as "<code>[Ljava.lang.String;</code>".
   * 
   * @param className the class name
   * @param initialize whether the class must be initialized
  ...
  /**
   * <p>
   * Returns the desired Method much like <code>Class.getMethod</code>, however it ensures
   * that the returned Method is from a public class or interface and not from an
   * anonymous inner class. This means that the Method is invokable and doesn't fall foul
   * of Java bug
  ...
  /**
   * <p>
   * Converts an array of <code>Object</code> in to an array of <code>Class</code>
   * objects.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Converts a given name of class into canonical format. If name of class is not a name
   * of array class it returns unchanged name.
   * </p>
   * <p>
   * Example:
   * <ul>
    ...
    if (className == null) {
      ...
      if (dim < 1) {
        ...
        if (className.startsWith("L")) {
          className = className.substring(1, className.endsWith(";") ? className.length() - 1
              : className.length());
        } else {
          if (className.length() > 0) {
