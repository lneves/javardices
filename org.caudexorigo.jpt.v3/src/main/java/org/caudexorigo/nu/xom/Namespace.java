...
/**
 * <p>
 * Represents a namespace in scope. It is used by XOM's XPath implementation for the
 * namespace axis. However, it is not really part of the XOM data model. Namespace objects
 * are only created as needed when evaluating XPath. While a namespace node has a parent
 * element (which may be null), that element does not know about these namespace nodes and
 * cannot remove them. (This is an inconsistency in the XPath data model, and is shared
 * with attributes which also have parents but are not children.)
 * </p>
 * 
...
public final class Namespace extends Node {
   ...
   * </p>
   * 
   * @param prefix the prefix for the namespace; may be the empty string or a
   *        non-colonized name
   ...
   *         <li>The prefix is not the empty string, and the URI is null or the empty
   *         string.</li>
   *         </ul>
   * @throws NamespaceConflictException if
   *         <ul>
   *         <li>The prefix is the empty string, and the URI is null or the empty
   *         string.</li>
  ...
  /**
   * <p>
   * Returns the namespace prefix, or the empty string if this node is the default
   * namespace.
   * </p>
   * 
  ...
  /**
   * <p>
   * Throws <code>IndexOutOfBoundsException</code> because namespaces do not have
   * children.
   * </p>
   * 
   ...
   * </p>
   * 
   * @return a copy of this <code>Namespace</code> that is not part of a document
   */
  public Node copy() {
   ...
   * </p>
   * 
   * @see org.caudexorigo.nu.xom.Node#detach()
   */
  public void detach() {
  ...
  /**
   * <p>
   * Returns a string containing the actual XML form of the namespace declaration
   * represented by this object. For example,
   * <code>xmlns:pre="http://www.example.org/"</code>.
   * </p>
   * 
   * @return a <code>String</code> containing an XML namespace declaration
   */
  public String toXML() {
  ...
  /**
   * <p>
   * Returns a string form of the <code>Namespace</code> suitable for debugging and
   * diagnosis. It deliberately does not return an actual XML namespace declaration.
   * </p>
   * 
