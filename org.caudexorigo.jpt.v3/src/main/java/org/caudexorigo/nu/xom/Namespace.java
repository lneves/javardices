...
public final class Namespace extends Node
{
	 ...
	 * 
	 * @param prefix
	 *            the prefix for the namespace; may be the empty string or a non-colonized name
	 * @param URI
	 *            the namespace URI
	 * @param parent
	 ...
	 *             <li>The prefix is not the empty string, and the URI is null or the empty string.</li>
	 *             </ul>
	 * @throws NamespaceConflictException
	 *             if
	 *             <ul>
	 *             <li>The prefix is the empty string, and the URI is null or the empty string.</li>
	 *             <li>The prefix is <code>xml</code>, and the URI is not <code>http://www.w3.org/XML/1998/namespace</code>.</li>
	 *             <li>The prefix is not <code>xml</code>, and the URI is <code>http://www.w3.org/XML/1998/namespace</code>.</li>
	 *             </ul>
	 */
	...
	/**
	 * <p>
	 * Throws <code>IndexOutOfBoundsException</code> because namespaces do not have children.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a string containing the actual XML form of the namespace declaration represented by this object. For example, <code>xmlns:pre="http://www.example.org/"</code>.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a string form of the <code>Namespace</code> suitable for debugging and diagnosis. It deliberately does not return an actual XML namespace declaration.
	 * </p>
	 * 
