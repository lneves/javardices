...
/**
 * <p>
 * <code>JVMRandom</code> is a wrapper that supports all possible Random methods via the {@link java.lang.Math#random()} method and its system-wide {@link Random} object.
 * </p>
 * 
 * @since 2.0
...
public final class JVMRandom extends Random
{
	...
	/**
	 * <p>
	 * Returns a pseudorandom, uniformly distributed long value between <code>0</code> (inclusive) and the specified value (exclusive), from the Math.random() sequence.
	 * </p>
	 * 
	 * @param n
	 *            the specified exclusive max-value
