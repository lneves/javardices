...
/**
 * <p>
 * Indicates an attempt to do or create something that could not possibly be serialized in
 * a namespace well-formed XML 1.0 document.
 * </p>
 * 
...
public class WellformednessException extends XMLException {
  ...
  /**
   * <p>
   * Creates a new <code>WellformednessException</code> with a detail message and an
