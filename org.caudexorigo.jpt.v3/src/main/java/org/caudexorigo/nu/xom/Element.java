 ...
 * 
 * You can contact Elliotte Rusty Harold by sending e-mail to elharo@ibiblio.org. Please
 * include the word "XOM" in the subject line. The XOM home page is located at
 * http://www.xom.nu/
 */
 ...
 * <li>A list of namespace declarations for this element (not including those inherited
 * from its parent)</li>
...
public class Element extends ParentNode {
   ...
   * 
   * @throws IllegalNameException if <code>name</code> is not a legal XML 1.0
   *         non-colonized name
   */
   ...
   * 
   * @throws IllegalNameException if <code>name</code> is not a legal XML 1.0 name
   * @throws NamespaceConflictException if <code>name</code>'s prefix cannot be used with
   *         <code>uri</code>
   * @throws MalformedURIException if <code>uri</code> is not an RFC 3986 absolute URI
   *         reference
   */
  ...
  /**
   * <p>
   * Creates a deep copy of an element. The copy is disconnected from the tree, and does
   * not have a parent.
   * </p>
   * 
    ...
    while (true) {
      if (!endTag && sourceCurrent.getChildCount() > 0) {
        ...
        if (sourceParent.getChildCount() - 1 == index) {
          ...
          top--;
          if (sourceCurrent == sourceElement)
            break;
          // switch parent up
  ...
  /**
   * <p>
   * Returns a list of the child elements of this element with the specified name in no
   * namespace. The elements returned are in document order.
   * </p>
   * 
   * @param name the name of the elements included in the list
   * 
   * @return a comatose list containing the child elements of this element with the
   *         specified name
   */
  ...
  /**
   * <p>
   * Returns a list of the immediate child elements of this element with the specified
   * local name and namespace URI. Passing the empty string or null as the local name
   * returns all elements in the specified namespace. Passing null or the empty string as
   * the namespace URI returns elements with the specified name in no namespace. The
   * elements returned are in document order.
   * </p>
   * 
   ...
   * 
   * @return a comatose list containing the child elements of this element with the
   *         specified name in the specified namespace
   */
  ...
  /**
   * <p>
   * Returns the first child element with the specified name in no namespace. If there is
   * no such element, it returns null.
   * </p>
   * 
   * @param name the name of the element to return
   * 
   * @return the first child element with the specified local name in no namespace or null
  ...
  /**
   * <p>
   * Returns the first child element with the specified local name and namespace URI. If
   ...
   * 
   * @return the first child with the specified local name in the specified namespace, or
  ...
  /**
   * <p>
   * Adds an attribute to this element, replacing any existing attribute with the same
   * local name and namespace URI.
   * </p>
   * 
   * @param attribute the attribute to add
   * 
   * @throws MultipleParentException if the attribute is already attached to an element
   * @throws NamespaceConflictException if the attribute's prefix is mapped to a different
   *         namespace URI than the same prefix is mapped to by this element, another
   *         attribute of this element, or an additional namespace declaration of this
   *         element
   */
  public void addAttribute(Attribute attribute) {
    ...
    if (attPrefix.length() != 0 && !"xml".equals(attPrefix)) {
      ...
      if (namespaces != null) {
        String existing = namespaces.getURI(attribute.getNamespacePrefix());
        if (existing != null
  ...
  /**
   * <p>
   * Returns the attribute with the specified name in no namespace, or null if this
   * element does not have an attribute with that name in no namespace.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the attribute with the specified name and namespace URI, or null if this
   * element does not have an attribute with that name in that namespace.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the value of the attribute with the specified name in no namespace, or null
   * if this element does not have an attribute with that name.
   * </p>
   * 
   * @param name the name of the attribute
   * 
   ...
   * 
   * <p>
   * Returns the number of attributes of this <code>Element</code>, not counting namespace
   ...
   * particular meaning. In particular, it is <em>not</em> necessarily the position of
   * this attribute in the original document from which this <code>Element</code> object
   * was read. As with most lists in Java, attributes are numbered from 0 to one less than
   * the length of the list.
   * </p>
   * 
   * <p>
   * In general, you should not add attributes to or remove attributes from the list while
   * iterating across it. Doing so will change the indexes of the other attributes in the
   * list. it is, however, safe to remove an attribute from either end of the list (0 or
   * <code>getAttributeCount()-1</code>) until there are no attributes left.
   * </p>
   * 
   ...
   *         to the number of attributes of this element
   * 
   */
  ...
  /**
   * <p>
   * Returns the value of the attribute with the specified name and namespace URI, or null
   ...
   * @param namespaceURI the namespace of the attribute
   * 
   * @return the value of the attribute of this element with the specified name and
   *         namespace
   */
  ...
  /**
   * <p>
   * Returns the complete name of this element, including the namespace prefix if this
   * element has one.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the prefix of this element, or the empty string if this element does not have
   * a prefix.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the namespace URI of this element, or the empty string if this element is not
   * in a namespace.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the namespace URI mapped to the specified prefix within this element. Returns
   * null if this prefix is not associated with a URI.
   * </p>
   * 
   ...
   * 
   * @throws IllegalNameException if <code>localName</code> is not a legal, non-colonized
   *         name
   */
   ...
   * 
   * @throws MalformedURIException if <code>uri</code> is not an absolute RFC 3986 URI
   *         reference
   * @throws NamespaceException if this element has a prefix and <code>uri</code> is null
   *         or the empty string; or if the element's prefix is shared by an attribute or
  ...
  /**
   * <p>
   * Sets the namespace prefix of this element. You can pass null or the empty string to
   * remove the prefix.
   * </p>
   * 
   * @param prefix the new namespace prefix
   * 
   * @throws IllegalNameException if <code>prefix</code> is not a legal XML non-colonized
   *         name
   * @throws NamespaceConflictException if <code>prefix</code> is already in use by an
   *         attribute or additional namespace with a different URI than the element
   *         itself
   */
  ...
  /**
   * <p>
   * Inserts a child node at the specified position. Inserting at position 0 makes the
   * child the first child of this node. Inserting at the position
   * <code>getChildCount()</code> makes the child the last child of the node.
   * </p>
   * 
   * <p>
   ...
   * 
   * @throws IllegalAddException if <code>child</code> is a <code>Document</code>
   * @throws MultipleParentException if <code>child</code> already has a parent
   * @throws NullPointerException if <code>child</code> is null
   * @throws IndexOutOfBoundsException if the position is negative or greater than the
   ...
   * 
   * <p>
   * Subclassers should note that the default implementation of this method does
   * <strong>not</strong> call <code>removeChild</code> or <code>detach</code>. If you
   * override <code>removeChild</code>, you'll probably need to override this method as
   * well.
   * </p>
   * 
   * @return a list of all the children removed in the order they appeared in the element
   */
  ...
  /**
   * <p>
   * Declares a namespace prefix. This is only necessary when prefixes are used in element
   * content and attribute values, as in XSLT and the W3C XML Schema Language. Do not use
   * this method to declare prefixes for element and attribute names.
   * </p>
   * 
   * <p>
   * You can supply an empty string for the prefix to declare a default namespace,
   * provided the element itself has a prefix.
   * </p>
   * 
   * <p>
   * If you do redeclare a prefix that is already used by an element or attribute name,
   * the additional namespace is added if and only if the URI is the same. Conflicting
   * namespace declarations will throw an exception.
   * </p>
   * 
   * @param prefix the prefix to declare
   * @param uri the absolute URI reference to map the prefix to
   * 
   * @throws MalformedURIException if <code>URI</code> is not an RFC 3986 URI reference
   * @throws IllegalNameException if <code>prefix</code> is not a legal XML non-colonized
   *         name or the empty string
   * @throws NamespaceConflictException if the mapping conflicts with an existing element,
   *         attribute, or additional namespace declaration
   */
  ...
  /**
   * <p>
   * Removes the mapping of the specified prefix. This method only removes additional
   * namespaces added with <code>addNamespaceDeclaration</code>. It has no effect on
   * namespaces of elements and attributes. If the prefix is not used on this element,
   ...
   * namespace of the element itself (which may be the empty string), the namespace of
   * each attribute, and each namespace added by <code>addNamespaceDeclaration</code>.
   * However, prefixes used multiple times are only counted once; and the <code>xml</code>
   * prefix used for <code>xml:base</code>, <code>xml:lang</code>, and
   * <code>xml:space</code> is not counted even if one of these attributes is present on
   * the element.
   * </p>
   * 
   * <p>
   * The return value is almost always positive. It can be zero if and only if the element
   * itself has the prefix <code>xml</code>; e.g. <code>&lt;xml:space /></code>. This is
   * not endorsed by the XML specification. The prefix <code>xml</code> is reserved for
   * use by the W3C, which has only used it for attributes to date. You really shouldn't
   * do this. Nonetheless, this is not malformed so XOM allows it.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the index<sup>th</sup> namespace prefix <em>declared</em> on this element.
   * Namespaces inherited from ancestors are not included. The index is purely for
   * convenience, and has no meaning in itself. This includes the namespaces of the
   * element name and of all attributes' names (except for those with the prefix
   * <code>xml</code> such as <code>xml:space</code>) as well as additional declarations
   * made for attribute values and element content. However, prefixes used multiple times
   * (e.g. on several attribute values) are only reported once. The default namespace is
   * reported with an empty string prefix if present. Like most lists in Java, the first
   * prefix is at index 0.
   * </p>
   * 
   * <p>
   * If the namespaces on the element change for any reason (adding or removing an
   * attribute in a namespace, adding or removing a namespace declaration, changing the
   * prefix of an element, etc.) then this method may skip or repeat prefixes. Don't
   ...
   *         or equal to the number of namespaces declared by this element.
   * 
   */
   ...
   * 
   * <p>
   * Sets the URI from which this element was loaded, and against which relative URLs in
   * this element will be resolved, unless an <code>xml:base</code> attribute overrides
   * this. Setting the base URI to null or the empty string removes any existing base URI.
   * </p>
   * 
   * @param URI the new base URI for this element
   * 
   * @throws MalformedURIException if <code>URI</code> is not a legal RFC 3986 absolute
   *         URI
   */
   ...
   * 
   * <p>
   * Returns the absolute base URI against which relative URIs in this element should be
   * resolved. <code>xml:base</code> attributes <em>in the same entity</em> take
   * precedence over the actual base URI of the document where the element was found or
   * which was set by <code>setBaseURI</code>.
   * </p>
   * 
   * <p>
   * This URI is made absolute before it is returned by resolving the information in this
   * element against the information in its parent element and document entity. However,
   * it is not always possible to fully absolutize the URI in all circumstances. In this
   * case, this method returns the empty string to indicate the base URI of the current
   * entity.
   * </p>
   * 
   * <p>
   * If the element's <code>xml:base</code> attribute contains a value that is a
   * syntactically illegal URI (e.g. %GF.html"), then the base URI is application
   * dependent. XOM's choice is to behave as if the element did not have an
  ...
  /**
   * <p>
   * Returns a string containing the XML serialization of this element. This includes the
   * element and all its attributes and descendants. However, it does not contain
   * namespace declarations for namespaces inherited from ancestor elements.
   * </p>
   * 
  ...
  /**
   * <p>
   * Returns the value of the element as defined by XPath 1.0. This is the complete PCDATA
   * content of the element, without any tags, comments, or processing instructions after
   * all entity and character references have been resolved.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a deep copy of this element with no parent, that can be added to this
   * document or a different one.
   * </p>
   * 
   * <p>
   * Subclassers should be wary. Implementing this method is trickier than it might seem,
   * especially if you wish to avoid potential stack overflows in deep documents. In
   * particular, you should not rely on the obvious recursive algorithm. Most subclasses
   * should override the {@link org.caudexorigo.nu.xom.Element#shallowCopy() shallowCopy}
   * method instead.
   * </p>
   * 
  ...
  /**
   * <p>
   * Creates a very shallow copy of the element with the same name and namespace URI, but
   * no children, attributes, base URI, or namespace declaration. This method is invoked
   * as necessary by the {@link org.caudexorigo.nu.xom.Element#copy() copy} method and the
   * {@link org.caudexorigo.nu.xom.Element#Element(org.caudexorigo.nu.xom.Element) copy
   * constructor}.
   * </p>
   * 
   * <p>
   * Subclasses should override this method so that it returns an instance of the subclass
   * so that types are preserved when copying. This method should not add any attributes,
   * namespace declarations, or children to the shallow copy. Any such items will be
   * overwritten.
   * </p>
   *
   ...
   * This is <em>not</em> the XML representation of the element.
   * </p>
   * 
