...
public class ParsingException extends Exception
{
	...
	/**
	 * <p>
	 * Creates a new <code>ParsingException</code> with a detail message and an underlying root cause.
	 * </p>
	 * 
	 * @param message
	...
	/**
	 * <p>
	 * Creates a new <code>ParsingException</code> with a detail message and line and column numbers.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
	...
	/**
	 * <p>
	 * Creates a new <code>ParsingException</code> with a detail message, line and column numbers, and an underlying exception.
	 * </p>
	 * 
	 * @param message
	 *            a string indicating the specific problem
