...
/**
 * <p>
 * Thrown when serializing documents that contain characters not available in the current
 * encoding, and which cannot be escaped (for instance, because they're in an element name
 * or processing instruction data). This can never happen if the encoding is UTF-8 or
 * UTF-16.
 * </p>
 * 
...
public class UnavailableCharacterException extends XMLException {
   ...
   * </p>
   *
   * @return the encoding used by the serializer when the exception was thrown
   */
