...
public final class FloatRange extends Range implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>FloatRange</code> using the specified number as both the
  ...
  /**
   * <p>
   * Constructs a new <code>FloatRange</code> with the specified minimum and maximum
  ...
  /**
   * <p>
   * Tests whether the specified range overlaps with this range using <code>float</code>
   * comparison.
   * </p>
   * 
   * <p>
  ...
  public boolean overlapsRange(Range range) {
    ...
    return range.containsFloat(min) || range.containsFloat(max) || containsFloat(range
        .getMinimumFloat());
  }
  ...
  public boolean equals(Object obj) {
    ...
    return (Float.floatToIntBits(min) == Float.floatToIntBits(range.min) && Float.floatToIntBits(
        max) == Float.floatToIntBits(range.max));
  }
