...
class JsonStringWriter extends Writer {
  private StringBuilder buf;

  /**
   * Create a new string writer using the default initial string-buffer size.
   */
  protected JsonStringWriter() {
   ...
   */
  protected JsonStringWriter(int initialSize) {
    if (initialSize < 0) {
   ...
   * 
   * <p>
   * An invocation of this method of the form <tt>out.append(csq)</tt> behaves in exactly
   ...
   * <tt>csq</tt>, the entire sequence may not be appended. For instance, invoking the
   * <tt>toString</tt> method of a character buffer will return a subsequence whose
   * content depends upon the buffer's position and limit.
   * 
   * @param csq The character sequence to append. If <tt>csq</tt> is <tt>null</tt>, then
   *        the four characters <tt>"null"</tt> are appended to this writer.
   * 
   * @return This writer
   * 
   * @since 1.5
   */
  public JsonStringWriter append(CharSequence csq) {
    if (csq == null)
      write("null");
    else
      write(csq.toString());
   ...
   * end)</tt> when <tt>csq</tt> is not <tt>null</tt>, behaves in exactly the same way as
   * the invocation
   * 
   * <pre>
   ...
   * @since 1.5
   */
  public JsonStringWriter append(CharSequence csq, int start, int end) {
   ...
   * 
   * <p>
   * An invocation of this method of the form <tt>out.append(c)</tt> behaves in exactly
   * the same way as the invocation
   * 
   * <pre>
   * out.write(c)
   ...
   * @since 1.5
   */
  public JsonStringWriter append(char c) {
    write(c);
    return this;
  }
