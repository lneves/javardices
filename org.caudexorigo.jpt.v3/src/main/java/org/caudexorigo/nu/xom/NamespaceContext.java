 ...
 *
 * <p>
 * A <code>NamespaceContext</code> is responsible for translating prefixes as they appear in XPath expressions into URIs for comparison. A document's prefixes are resolved internal to the document based upon its own namespace nodes.
 * </p>
 * 
 * <p>
...
public interface NamespaceContext
{
	 ...
	 *
	 * <p>
	 * In XPath, there is no such thing as a 'default namespace'. The empty prefix <strong>always</strong> resolves to the empty namespace URI. This method should return null for the empty prefix. Similarly, the prefix "xml" always resolves to the URI "http://www.w3.org/XML/1998/namespace".
	 * </p>
	 *
	 * @param prefix
