 ...
 * 
 * <p>
 * This class tries to handle <code>null</code> input gracefully. An exception will
 * generally not be thrown for a <code>null</code> input. Each method documents its
...
public class ObjectUtils {
  ...
  /**
   * <p>
   * Singleton used as a <code>null</code> placeholder where <code>null</code> has another
   * meaning.
   * </p>
   * 
   * <p>
   * For example, in a <code>HashMap</code> the
   * {@link java.util.HashMap#get(java.lang.Object)} method returns <code>null</code> if
   * the <code>Map</code> contains <code>null</code> or if there is no matching key. The
  ...
  /**
   * <p>
   * <code>ObjectUtils</code> instances should NOT be constructed in standard programming.
  ...
  /**
   * <p>
   * Gets the toString that would be produced by <code>Object</code> if a class did not
   * override toString itself. <code>null</code> will return <code>null</code>.
   * </p>
   * 
   * <pre>
   ...
   * @return the default toString text, or <code>null</code> if <code>null</code> passed
   *         in
   */
  ...
  /**
   * <p>
   * Appends the toString that would be produced by <code>Object</code> if a class did not
   * override toString itself. <code>null</code> will throw a NullPointerException for
  ...
  public static void identityToString(StringBuilder buffer, Object object) {
    ...
    buffer.append(object.getClass().getName()).append('@').append(Integer.toHexString(System
  ...
  public static StringBuilder appendIdentityToString(StringBuilder buffer, Object object) {
    ...
    return buffer.append(object.getClass().getName()).append('@').append(Integer.toHexString(System
        .identityHashCode(object)));
  }
  ...
  /**
   * <p>
   * Gets the <code>toString</code> of an <code>Object</code> returning a specified text
   * if <code>null</code> input.
   * </p>
   * 
   * <pre>
