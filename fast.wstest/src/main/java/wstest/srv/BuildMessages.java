...
public class BuildMessages {
  ...
  // FileOutputStream("./bench/post_files/getorder" + size + ".javabin"));
  // ObjectMapper json_out = new ObjectMapper();
  //
  // out.writeObject(go);
  // json_out.writeValue(new FileOutputStream("./bench/post_files/getorder" + size +
  // ".json"), go);
  // }
  //
  ...
  //
  // ObjectOutputStream out = new ObjectOutputStream(new
  // FileOutputStream("./bench/post_files/echostruct" + size + ".javabin"));
  // ObjectMapper json_out = new ObjectMapper();
  //
  // out.writeObject(cots);
  // json_out.writeValue(new FileOutputStream("./bench/post_files/echostruct" + size +
  // ".json"), cots);
  //
  // }
  //
  ...
  //
  // ObjectOutputStream out = new ObjectOutputStream(new
  // FileOutputStream("./bench/post_files/echolist" + size + ".javabin"));
  // ObjectMapper json_out = new ObjectMapper();
  //
  // out.writeObject(tn0);
  // json_out.writeValue(new FileOutputStream("./bench/post_files/echolist" + size +
  // ".json"), tn0);
  //
  // }
  //
  // private static final TestNode fill(TestNode tn_parent, int i, float f, String s, int
  // limit)
  // {
  // try
  // {
