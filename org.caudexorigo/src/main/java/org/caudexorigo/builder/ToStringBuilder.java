 ...
 * 
 * <p>
 * This class enables a good and consistent <code>toString()</code> to be built for any class or object. This class aims to simplify the process by:
 * </p>
 * <ul>
 ...
 * 
 * <p>
 * To add the superclass <code>toString</code>, use {@link #appendSuper}. To append the <code>toString</code> from an object that is delegated to (or any other object), use {@link #appendToString}.
 * </p>
 * 
 * <p>
...
public class ToStringBuilder
{
	 ...
	 * 
	 * <p>
	 * A boolean parameter controls the level of detail to show. Setting <code>true</code> will output the array in full. Setting <code>false</code> will output a summary, typically the size of the array.
	 * </p>
	 * 
	 * @param fieldName
	 *            the field name
	 ...
	 * 
	 * <p>
	 * This method is useful where a class delegates most of the implementation of its properties to another class. You can then call <code>toString()</code> on the other class and pass the result into this method.
	 * </p>
	 * 
	 * <pre>
	 ...
	 * 
	 * <p>
	 * This method appends the end of data indicator, and can only be called once. Use {@link #getStringBuilder} to get the current string state.
	 * </p>
	 * 
	 * <p>
