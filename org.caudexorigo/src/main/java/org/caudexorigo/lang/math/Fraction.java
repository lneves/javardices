...
public final class Fraction extends Number implements Comparable
{
	 ...
	 * 
	 * <p>
	 * This method uses the <a href="http://archives.math.utk.edu/articles/atuyl/confrac/"> continued fraction algorithm</a>, computing a maximum of 25 convergents and bounding the denominator by 10,000.
	 * </p>
	 * 
	 * @param value
	 ...
	 * </p>
	 * 
	 * @return <code>this</code> if it is positive, or a new positive fraction instance with the opposite signed numerator
	 */
	public Fraction abs()
	{
		if (numerator >= 0)
	 ...
	 * @return <code>this</code> if the power is one, <code>ONE</code> if the power is zero (even if the fraction equals ZERO) or a new fraction instance raised to the appropriate power
	 * @throws ArithmeticException
	 ...
	 * 
	 * <p>
	 * The format used in '<i>wholeNumber</i> <i>numerator</i>/<i>denominator</i>'. If the whole number is zero it will be ommitted. If the numerator is zero, only the whole number is returned.
	 * </p>
	 * 
	 * @return a <code>String</code> form of the fraction
	 */
