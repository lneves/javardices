...
/**
 * <p>
 * <code>DoubleRange</code> represents an inclusive range of <code>double</code>s.
 * </p>
 * 
...
public final class DoubleRange extends Range implements Serializable {
  ...
  /**
   * <p>
   * Constructs a new <code>DoubleRange</code> using the specified number as both the
  ...
  /**
   * <p>
   * Constructs a new <code>DoubleRange</code> with the specified minimum and maximum
   * numbers (both inclusive).
   * </p>
   * 
   * <p>
   * The arguments may be passed in the order (min,max) or (max,min). The getMinimum and
   ...
   * 
   * <p>
   * This implementation overrides the superclass for performance as it is the most common
   * case.
   * </p>
   * 
  ...
  /**
   * <p>
   * Tests whether the specified range overlaps with this range using <code>double</code>
   * comparison.
   * </p>
   * 
   * <p>
  ...
  public boolean overlapsRange(Range range) {
    ...
    return range.containsDouble(min) || range.containsDouble(max) || containsDouble(range
        .getMinimumDouble());
  }
  ...
  public boolean equals(Object obj) {
    ...
    return (Double.doubleToLongBits(min) == Double.doubleToLongBits(range.min) && Double
