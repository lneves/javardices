...
public class XhtmlEntityResolver implements EntityResolver2 {
  ...
  public InputSource getExternalSubset(String name, String baseURI) throws SAXException,
    ...
    //
    // return new
    // InputSource(getClass().getResourceAsStream("/org/caudexorigo/etc/catalogs/html/html.dtd"));
    // else
    // return new InputSource(new StringReader(""));

    // always return the html dtd
    return new InputSource(getClass().getResourceAsStream(
        "/org/caudexorigo/etc/catalogs/html/html.dtd"));
  ...
  public InputSource resolveEntity(String name, String publicID, String baseURI, String systemID)
    ...
    if (systemID.contains("html-lat1.ent"))
      return new InputSource(getClass().getResourceAsStream(
          "/org/caudexorigo/etc/catalogs/html/html-lat1.ent"));
    if (systemID.contains("html-symbol.ent"))
      return new InputSource(getClass().getResourceAsStream(
          "/org/caudexorigo/etc/catalogs/html/html-symbol.ent"));
    if (systemID.contains("html-special.ent"))
      return new InputSource(getClass().getResourceAsStream(
          "/org/caudexorigo/etc/catalogs/html/html-special.ent"));
