/*
 * $Header: /home/jerenkrantz/tmp/commons/commons-convert/cvs/home/cvs/jakarta-commons-sandbox//i18n/src/java/org/apache/commons/i18n/LocalizedText.java,v 1.1 2004/10/04 13:41:09 dflorey Exp $
 * $Revision: 171112 $
...
import org.caudexorigo.i18n.LocalizedBundle;
import org.caudexorigo.i18n.MessageNotFoundException;

/**
 * <p>
 * The <code>TextBundle</code> represents the most simple localized bundle with just one single entry. Use this class if you want to deal with simple localized strings that may contain dynamic elements.
 * </p>
 * 
 */
public class TextBundle extends LocalizedBundle
{
	...
	private static final long serialVersionUID = 5268642775502885809L;
	 ...
	 *             is thrown if no entry with key <code>text</code> could be found in the message bundle identified by the given message identifier
	 */
	 ...
	 *            The locale that is used to find the appropriate localized text
	 * @param defaultText
	 *            The default text will be returned, if no entry with key <code>text</code> could be found in the message bundle identified by the given message identifier
	 * @return returns the localized message entry with the key <code>text</code>
	 */
