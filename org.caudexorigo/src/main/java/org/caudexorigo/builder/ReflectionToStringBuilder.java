 ...
 * </p>
 * <p>
 * For example, this method does <i>not</i> include the <code>password</code> field in the
...
public class ReflectionToStringBuilder extends ToStringBuilder {
   ...
   * This means that it will throw a security exception if run under a security manager,
   * if the permissions are not set up correctly. It is also not as efficient as testing
   * explicitly.
   * </p>
   * 
   * <p>
   * Transient members will be not be included, as they are likely derived. Static fields
   * will not be included. Superclass fields will be appended.
   * </p>
   * 
   ...
   * 
   * <p>
   * If the <code>outputTransients</code> is <code>true</code>, transient members will be
   * output, otherwise they are ignored, as they are likely derived fields, and not part
   ...
   * 
   * <p>
   * If the <code>outputTransients</code> is <code>true</code>, transient fields will be
   * output, otherwise they are ignored, as they are likely derived fields, and not part
   * of the value of the Object.
   * </p>
   * 
   * <p>
   * If the <code>outputStatics</code> is <code>true</code>, static fields will be output,
   ...
   * 
   * <p>
   * Superclass fields will be appended up to and including the specified superclass. A
   * null superclass is treated as <code>java.lang.Object</code>.
   * </p>
   * 
   * <p>
   * If the style is <code>null</code>, the default <code>ToStringStyle</code> is used.
   ...
   * 
   * <p>
   * Static fields will not be included. Superclass fields will be appended up to and
   * including the specified superclass. A null superclass is treated as
  ...
  /**
   * Converts the given Collection into an array of Strings. The returned array does not
   * contain <code>null</code> entries. Note that {@link Arrays#sort(Object[])} will throw
   * an {@link NullPointerException} if an array element is <code>null</code>.
   * 
  ...
  /**
   * Returns a new array of Strings without null elements. Internal method used to
   * normalize exclude lists (arrays and collections). Note that
   * {@link Arrays#sort(Object[])} will throw an {@link NullPointerException} if an array
   ...
   * </p>
   * 
   * @param object the Object to build a <code>toString</code> for, must not be
   *        <code>null</code>
   ...
   * @param style the style of the <code>toString</code> to create, may be
   *        <code>null</code>
   * @param buffer the <code>StringBuilder</code> to populate, may be <code>null</code>
   * @throws IllegalArgumentException if the Object passed in is <code>null</code>
   */
   ...
   * 
   * @deprecated Use
   *             {@link #ReflectionToStringBuilder(Object,ToStringStyle,StringBuilder,Class,boolean,boolean)}.
   * 
   * @param object the Object to build a <code>toString</code> for
   * @param style the style of the <code>toString</code> to create, may be
   *        <code>null</code>
  ...
  protected boolean accept(Field field) {
    ...
    if (this.getExcludeFieldNames() != null && Arrays.binarySearch(this.getExcludeFieldNames(),
        field.getName()) >= 0) {
   ...
   * 
   * <p>
   * If a cycle is detected as an object is &quot;toString()'ed&quot;, such an object is
   * rendered as if <code>Object.toString()</code> had been called and not implemented by
   * the object.
   * </p>
   * 
