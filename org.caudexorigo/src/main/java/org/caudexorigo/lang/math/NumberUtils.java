...
public class NumberUtils {
  ...
  /**
   * <p>
   * Convert a <code>String</code> to an <code>int</code>, returning <code>zero</code> if
   ...
   * @deprecated Use {@link #toInt(String)} This method will be removed in Commons Lang
   *             3.0
   */
   ...
   * @deprecated Use {@link #toInt(String, int)} This method will be removed in Commons
   *             Lang 3.0
   */
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>long</code>, returning <code>zero</code> if
   * the conversion fails.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>float</code>, returning <code>0.0f</code> if
   * the conversion fails.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>float</code>, returning a default value if
   * the conversion fails.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>double</code>, returning <code>0.0d</code>
   ...
   * 
   * @param str the string to convert, may be <code>null</code>
   * @return the double represented by the string, or <code>0.0d</code> if conversion
   *         fails
   * @since 2.1
   */
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>double</code>, returning a default value if
   * the conversion fails.
   * </p>
   * 
   * <p>
   ...
   * (<code>'f','F','d','D','l','L'</code>). If it is found, it starts trying to create
   ...
   * successively larger types from <code>Integer</code> to <code>BigInteger</code> and
   * from <code>Float</code> to <code>BigDecimal</code>.
   * </p>
   * 
   * <p>
   * If the string starts with <code>0x</code> or <code>-0x</code>, it will be interpreted
   * as a hexadecimal integer. Values with leading <code>0</code>'s will not be
   ...
   * 
   * <p>
   * This method does not trim the input string, i.e., strings with leading or trailing
   * spaces will generate NumberFormatExceptions.
   * </p>
   * 
  ...
  public static Number createNumber(String str) throws NumberFormatException {
    ...
    if (!Character.isDigit(lastChar)) {
      ...
      switch (lastChar) {
        case 'l':
        case 'L':
          if (dec == null && exp == null && (numeric.charAt(0) == '-' && isDigits(numeric.substring(
              1)) || isDigits(numeric))) {
            try {
  ...
  /**
   * <p>
   * Convert a <code>String</code> to a <code>Integer</code>, handling hex and octal
   * notations.
   * </p>
   * 
   * <p>
   ...
   * @throws IllegalArgumentException if <code>array</code> is <code>null</code>
   * @throws IllegalArgumentException if <code>array</code> is empty
   * @see IEEE754rUtils#min(double[]) IEEE754rUtils for a version of this method that
   ...
   * @throws IllegalArgumentException if <code>array</code> is <code>null</code>
   * @throws IllegalArgumentException if <code>array</code> is empty
   * @see IEEE754rUtils#min(float[]) IEEE754rUtils for a version of this method that
   *      handles NaN differently
   */
   ...
   * @throws IllegalArgumentException if <code>array</code> is <code>null</code>
   * @throws IllegalArgumentException if <code>array</code> is empty
   * @see IEEE754rUtils#max(double[]) IEEE754rUtils for a version of this method that
   *      handles NaN differently
   */
   ...
   * @throws IllegalArgumentException if <code>array</code> is <code>null</code>
   * @throws IllegalArgumentException if <code>array</code> is empty
   * @see IEEE754rUtils#max(float[]) IEEE754rUtils for a version of this method that
   *      handles NaN differently
   */
   ...
   * @param c value 3
   * @return the smallest of the values
   * @see IEEE754rUtils#min(double, double, double) for a version of this method that
   *      handles NaN differently
   */
   ...
   * @param c value 3
   * @return the largest of the values
   * @see IEEE754rUtils#max(double, double, double) for a version of this method that
   *      handles NaN differently
   */
   ...
   * 
   * <p>
   * This method is more comprehensive than the standard Java greater than, less than and
   * equals operators.
   * </p>
   * <ul>
   ...
   * @return <code>-1</code> if lhs is less, <code>+1</code> if greater, <code>0</code> if
   *         equal to rhs
   */
