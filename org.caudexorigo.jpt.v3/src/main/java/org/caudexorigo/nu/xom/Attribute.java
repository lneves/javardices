...
/**
 * <p>
 * This class represents an attribute such as <code>type="empty"</code> or <code>xlink:href="http://www.example.com"</code>.
 * </p>
 * 
 * <p>
 * Attributes that declare namespaces such as <code>xmlns="http://www.w3.org/TR/1999/xhtml"</code> or <code>xmlns:xlink="http://www.w3.org/TR/1999/xlink"</code> are stored separately on the elements where they appear. They are never represented as <code>Attribute</code> objects.
 * </p>
 * 
...
public class Attribute extends Node
{
	 ...
	 *             if the local name is not a namespace well-formed, non-colonized name
	 ...
	 * 
	 * @throws IllegalNameException
	 *             if the name is not a namespace well-formed name
	 * @throws IllegalDataException
	 *             if the value contains characters which are not legal in XML such as vertical tab or a null. Note that characters such as " and &amp; are legal, but will be automatically escaped when the attribute is serialized.
	 * @throws MalformedURIException
	 *             if <code>URI</code> is not an RFC 3986 URI reference
	 * @throws NamespaceConflictException
	 *             if there's no prefix, but the URI is not the empty string, or the prefix is <code>xml</code> and the URI is not http://www.w3.org/XML/1998/namespace
	 */
	 ...
	 * 
	 * @throws IllegalNameException
	 *             if the name is not a namespace well-formed prefixed name
	 * @throws IllegalDataException
	 *             if the value contains characters which are not legal in XML such as vertical tab or a null. Note that characters such as " and &amp; are legal, but will be automatically escaped when the attribute is serialized.
	 * @throws MalformedURIException
	...
	/**
	 * <p>
	 * Returns the DTD type of this attribute. If this attribute does not have a type, then <code>Type.UNDECLARED</code> is returned.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Sets the type of this attribute to one of the ten DTD types or <code>Type.UNDECLARED</code>.
	 * </p>
	 * 
	 * @param type
	 ...
	 * @throws IllegalDataException
	 *             if this is an <code>xml:id</code> attribute and the <code>type</code> is not ID
	 */
	 ...
	 * 
	 * @throws IllegalNameException
	 *             if <code>localName</code> is not a namespace well-formed, non-colonized name
	 * 
	 */
	 ...
	 *             if
	 *             <ul>
	 *             <li>The prefix is <code>xml</code> and the namespace URI is not <code>http://www.w3.org/XML/1998/namespace</code>.</li>
	 *             <li>The prefix conflicts with an existing declaration on the attribute's parent element.</li>
	 *             </ul>
	 */
	...
	/**
	 * <p>
	 * Throws <code>IndexOutOfBoundsException</code> because attributes do not have children.
	 * </p>
	 *
	 * @param position
	 *            the child to return
	...
	public static final class Type
	{
		...
		/**
		 * <p>
		 * Tests for type equality. This is only necessary, to handle the case where two <code>Type</code> objects are loaded by different class loaders.
		 * </p>
		 * 
		 * @param o
