...
public class NettyHttpServerInitializer extends ChannelInitializer<SocketChannel> {
  ...
  public NettyHttpServerInitializer(RequestRouter mapper, RequestObserver requestObserver,
      ResponseFormatter responseFormatter, int maxLength, boolean validate_headers) {
    super();
    this.mapper = mapper;
  ...
  public void initChannel(SocketChannel ch) throws Exception {
    ...
    pipeline.addLast("http-decoder", new HttpRequestDecoder(maxInitialLineLength, maxHeaderSize,
        maxChunkSize, validate_headers));
    ...
    pipeline.addLast("http-protocol-handler", new HttpProtocolHandler(mapper, requestObserver,
        responseFormatter));
  }
}
