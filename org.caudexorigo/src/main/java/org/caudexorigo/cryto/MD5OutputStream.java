 ...
 * 
 * written Santeri Paavolainen, Helsinki Finland 1996 (c) Santeri Paavolainen, Helsinki
 * Finland 1996 modifications Copyright (C) 2002 Stephen Ostermiller
...
/**
 * Implements MD5 functionality on a stream. More information about this class is
 * available from
 * <a target="_top" href= "http://ostermiller.org/utils/MD5.html">ostermiller.org </a>.
 * <p>
 * This class produces a 128-bit "fingerprint" or "message digest" for all data written to
 * this stream. It is conjectured that it is computationally infeasible to produce two
 * messages having the same message digest, or to produce any message having a given
 * pre-specified target message digest. The MD5 algorithm is intended for digital
 * signature applications, where a large file must be "compressed" in a secure manner
...
public class MD5OutputStream extends FilterOutputStream {
  ...
  /**
   * Writes len bytes from the specified byte array starting a offset off to this output
   * stream.
   * 
   * @param b the data.
