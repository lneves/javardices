...
/**
 * <p>
 * Indicates that a string intended for use as a URI or URI reference (typically a
 * namespace name or a base URI) is not syntactically correct according to
 * <a href="http://www.ietf.org/rfc/rfc3986.txt" target="_top">RFC 3986</a>.
 * </p>
 * 
...
public class MalformedURIException extends IllegalDataException {
  ...
  /**
   * <p>
   * Creates a new <code>MalformedURIException</code> with a detail message and an
