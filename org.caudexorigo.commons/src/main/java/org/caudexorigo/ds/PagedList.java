...
/**
 * Implements a list which can be divided into several pages. There are several methods
 * like moveToPage(int page) or moveToLastPage() for page-oriented navigation in the list.
 * The objects on the current page can be retrieved by calling iterator(). <br>
 * This class is very handy to implement resultlists, where users can page through a list
 * of objects. <br>
...
public class PagedList<T> extends ArrayList<T> {
   ...
   * 
   * @param pageSize Page size to use for the list.
   */
  ...
  /**
   * Creates a new empty list with the given page-size and initial capacity. Paging is
   * enabled by default.
   * 
  ...
  /**
   * Creates a new list containing the objects of the specified collection with a default
   * page-size of 10 and paging enabled.
   * 
   * @param collection The collection whose objects are to be placed into this list.
   */
  ...
  /**
   * Calculates the internal values for paging. This method called on demand when objects
   * have been added or removed to/from the list.
   */
  ...
  /**
   * Return an iterator for the objects contained on the current page. If paging is
   * disabled, the iterator will contain all objects.
   * 
  ...
  /**
   * Appends the specified object to the end of the list. All paging values are adjusted
   * according to the new list size.
   * 
  ...
  /**
   * Inserts the specified object at the specified position in the list. All paging values
   * are adjusted according to the new list size.
   * 
  ...
  /**
   * Appends all of the objects in the specified collection to the end of the list. All
   * paging values are adjusted according to the new list size.
   * 
   * @param collection The collectioen containing the objects to append.
   * @return Description of the Return Value
   */
  ...
  /**
   * Inserts all of the objects in the specified collection beginning at the specified
   * position. All paging values are adjusted according to the new list size.
   * 
   * @param index The position to insert the objects
   * @param collection The collectioen containing the objects to append.
   * @return Description of the Return Value
   */
  ...
  /**
   * // * Remove a range of objects // * // * @param fromIndex // * start index //
   ...
   * 
   * @param collection The objects to be retained
   ...
   * 
   * @param pagingEnabled Flag to enabled or disable the paging mode
   */
   ...
   * 
   * @param pageNumber Description of the Parameter
   * @return true if the page was moved. false if the page was not moved because it would
   ...
   * 
   * @return true if the page was moved. false if the page was not moved because it was
  ...
  /*
   * public static void main(String[] args) { System.out.println(">>>>>> Start Test"); //
   * Create the list with given page size PagedList pagedList = new PagedList(5); // Add
   * some objects int i = 0; while (i < 12) { pagedList.add(new Integer(i++)); }
   * System.out.println("List Size:................." + pagedList.size());
   * System.out.println("Page Count:................" + pagedList.getPageCount());
   * pagedList.moveToPage(1); System.out.println("Items on page 1:..........."); Iterator
   * iterator = pagedList.iterator(); while (iterator.hasNext()) { Object item =
   * iterator.next(); System.out.println(item.toString()); }
   * 
   * pagedList.moveToFirstPage(); System.out.println("Items on first page:.......");
   * iterator = pagedList.iterator(); while (iterator.hasNext()) { Object item =
   * iterator.next(); System.out.println(item.toString()); }
   * 
   * pagedList.moveToLastPage(); System.out.println("Items on last page:........");
   * iterator = pagedList.iterator(); while (iterator.hasNext()) { Object item =
   * iterator.next(); System.out.println(item.toString()); } // Add more objects while (i
   * < 21) { pagedList.add(new Integer(i++)); }
   * System.out.println("List Size:................." + pagedList.size());
   * System.out.println("Page Count:................" + pagedList.getPageCount());
   * 
   * pagedList.moveToLastPage(); System.out.println("Items on last page:........");
