...
public abstract class JptParentNode extends JptNode {
  ...
  public JptNode getChild(int position) {
    /*
     * if (children == null) throw new
     * IndexOutOfBoundsException("This node has no children"); else
     */
  ...
  protected void checkAllowed(Map<String, Object> context, String variable) {
    if (context.containsKey(variable)) {
      throw new IllegalStateException(String.format("Variable '%s' is already in context",
          variable));
    }
  }
}
