...
class ArgumentPresenterImpl<O> implements ArgumentPresenter<O> {
  ...
  public O presentArguments(final TypedArguments arguments) {
    final O result = (O) Proxy.newProxyInstance(m_klass.getClassLoader(), new Class[] {m_klass},
        new InvocationHandler() {
          public Object invoke(final Object proxy, final Method method, final Object[] args)
              throws Throwable {
            if (args != null && args.length != 0) {
              throw new UnsupportedOperationException(String.format(
                  "Method (%s) with arguments not supported for reading argument values", method
                      .toGenericString()));
              ...
              throw new UnsupportedOperationException(String.format(
                  "Method (%s) is not annotated for option specification", method
                      .toGenericString()));
            }
          ...
          private Object optionPresent(final TypedArguments arguments,
              final ArgumentSpecification specification) {
            return arguments.contains(specification);
          }

          private Object getValue(final TypedArguments arguments, final Method method,
              final ArgumentSpecification specification) throws NoSuchMethodException,
