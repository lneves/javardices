...
import org.caudexorigo.builder.EqualsBuilder;
import org.caudexorigo.builder.HashCodeBuilder;
...
/**
 * <p>
 * Operations on arrays, primitive arrays (like <code>int[]</code>) and primitive wrapper
 * arrays (like <code>Integer[]</code>).
 * </p>
 * 
 * <p>
 * This class tries to handle <code>null</code> input gracefully. An exception will not be
 * thrown for a <code>null</code> array input. However, an Object array that contains a
 * <code>null</code> element may throw an exception. Each method documents its behaviour.
 * </p>
 * 
...
public class ArrayUtils {
   ...
   * This value is returned by methods in this class and can also be used in comparisons
   * with values returned by various method from {@link java.util.List}.
   */
  public static final int INDEX_NOT_FOUND = -1;

  /**
   * <p>
   * ArrayUtils instances should NOT be constructed in standard programming. Instead, the
   * class should be used as <code>ArrayUtils.clone(new int[] {2})</code>.
   * </p>
   * 
   * <p>
   ...
   * 
   * <p>
   * Multi-dimensional arrays are handled correctly, including multi-dimensional primitive
   * arrays.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Converts the given array into a {@link java.util.Map}. Each element of the array must
   * be either a {@link java.util.Map.Entry} or an Array, containing at least two
   ...
   *        Array containing at least two elements, may be <code>null</code>
   ...
   * 
   * <p>
   * The start index is inclusive, the end index exclusive. Null array input produces null
   * output.
   * </p>
   * 
   * <p>
   * The component type of the subarray is always the same as that of the input array.
   * Thus, if the input is an array of type <code>Date</code>, the following usage is
   * envisaged:
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Produces a new <code>long</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>int</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>short</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>char</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>byte</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>double</code> array containing the elements between the start
   * and end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>float</code> array containing the elements between the start and
   * end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Produces a new <code>boolean</code> array containing the elements between the start
   * and end indices.
   * </p>
   * 
   * <p>
  ...
  /**
   * <p>
   * Checks whether two arrays are the same length, treating <code>null</code> arrays as
   * length <code>0</code>.
   * 
   * <p>
   ...
   * @return <code>true</code> if length of arrays matches, treating <code>null</code> as
   *         an empty array
   */
  public static boolean isSameLength(Object[] array1, Object[] array2) {
    if ((array1 == null && array2 != null && array2.length > 0) || (array2 == null && array1 != null
        && array1.length > 0) || (array1 != null && array2 != null
   ...
   * will return {@link #INDEX_NOT_FOUND} (<code>-1</code>).
   * </p>
   * 
   * @param array the array to search through for the object, may be <code>null</code>
   * @param objectToFind the object to find, may be <code>null</code>
   ...
   * 
   * <p>
   * A negative startIndex will return {@link #INDEX_NOT_FOUND} (<code>-1</code>). A
  ...
  /**
   * <p>
   * Finds the index of the given value within a given tolerance in the array. This method
   * will return the index of the first value which falls between the region defined by
   ...
   * method will return the index of the last value which falls between the region defined
   ...
   * 
   * <p>
   * This method returns {@link #INDEX_NOT_FOUND} (<code>-1</code>) if <code>null</code>
   * array input.
   * </p>
   * 
   * @param array the array to travers backwords looking for the object, may be
  ...
  /**
   * <p>
   * Converts an array of object Character to primitives handling <code>null</code>.
   * </p>
   * 
   * <p>
   * This method returns <code>null</code> for a <code>null</code> input array.
  ...
  /**
   * <p>
   * Converts an array of object Doubles to primitives handling <code>null</code>.
   * </p>
   * 
   * <p>
   * This method returns <code>null</code> for a <code>null</code> input array.
  ...
  /**
   * <p>
   * Converts an array of object Booleans to primitives handling <code>null</code>.
   * </p>
   * 
   * <p>
   * This method returns <code>null</code> for a <code>null</code> input array.
   ...
   * </p>
   * <p>
   * The new array contains all of the element of <code>array1</code> followed by all of
   * the elements <code>array2</code>. When an array is returned, it is always a new
   * array.
   * </p>
   * 
   * <pre>
   ...
   *        <code>null</code>
   * @return The new array, <code>null</code> if <code>null</code> array inputs. The type
   ...
   * 
   * <p>
   * The new array contains the same elements of the input array plus the given element in
   * the last position. The component type of the new array is the same as that of the
   * input array.
   * </p>
   * 
   * <p>
   * If the input array is <code>null</code>, a new one element array is returned whose
  ...
  /**
   * Returns a copy of the given array of size 1 greater than the argument. The last value
   * of the array is left to the default value.
   * 
   ...
   * given element on the specified position. The component type of the returned array is
   ...
   * subsequent elements are shifted to the left (substracts one from their indices).
   * </p>
   * 
   * <p>
   * This method returns a new array with the same elements of the input array except the
   * element on the specified position. The component type of the returned array is always
   * the same as that of the input array.
   * </p>
   * 
   * <p>
   * If the input array is <code>null</code>, an IndexOutOfBoundsException will be thrown,
   ...
   * subsequent elements are shifted to the left (substracts one from their indices). If
   * the array doesn't contains such an element, no elements are removed from the array.
   * </p>
   * 
   * <p>
   * This method returns a new array with the same elements of the input array except the
   * first occurrence of the specified element. The component type of the returned array
