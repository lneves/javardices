...
/**
 * <p>
 * This class represents a run of text. CDATA sections are not treated differently than normal text. <code>Text</code> objects may be adjacent to other <code>Text</code> objects.
 * </p>
 * 
 * <p>
...
public class Text extends Node
{
	 ...
	 * 
	 * @param text
	 *            the <code>Text</code> object to copy
	 */
	...
	/**
	 * <p>
	 * Returns the XPath 1.0 string-value of this <code>Text</code> node. The XPath string-value of a text node is the same as the text of the node.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a deep copy of this <code>Text</code> with no parent, that can be added to this document or a different one.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Returns a string containing the XML serialization of this text node. Unlike <code>getValue</code>, this method escapes characters such as &amp; and &lt; using entity references such as <code>&amp;amp;</code> and <code>&amp;lt;</code>. It escapes the carriage return (\r) as <code>&amp;#x0D;</code>. If this text node is a CDATA section, then it may wrap the value in CDATA section delimiters instead of escaping.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Returns a <code>String</code> representation of this <code>Text</code> suitable for debugging and diagnosis. This is <em>not</em> the XML representation of this <code>Text</code> node.
	 * </p>
	 * 
