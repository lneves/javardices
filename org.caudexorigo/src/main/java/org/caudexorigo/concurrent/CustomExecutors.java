...
public class CustomExecutors {
  public static ThreadPoolExecutor newThreadPool(int maxThreads, String threadPrefix) {
    ...
    ThreadPoolExecutor exec_srv = new ThreadPoolExecutor(maxThreads, maxThreads, 30L,
        TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(maxThreads * 50), tf,
  ...
  public static ThreadPoolExecutor newCachedThreadPool(String threadPrefix) {
    ThreadFactory tf = new DefaultThreadFactory(threadPrefix);
    ThreadPoolExecutor exec_srv = new ThreadPoolExecutor(0, 1024, 30L, TimeUnit.SECONDS,
        new SynchronousQueue<Runnable>(), tf, new ThreadPoolExecutor.AbortPolicy());
    return exec_srv;
  }

  public static ScheduledThreadPoolExecutor newScheduledThreadPool(int maxThreads,
      String threadPrefix) {
    ThreadFactory tf = new DefaultThreadFactory(threadPrefix);
